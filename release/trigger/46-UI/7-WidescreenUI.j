...
/*
    ...
    How to use this library:
        ...
        - Attach all points of a frame to UIView.WorldFrame and it will fill the entire screen and reposition when resolution changes.
        
        - Do not use UIView.LEFT_BORDER, UIView.RIGHT_BORDER or UIView.WorldFrame as parents unless you know what you're doing.
...
struct UIView
    ...
    • Values might be async between clients
        ...
        - Frames
            ...
            - The third child of ConsoleUIBackdrop that is 
                | readonly static framehandle WorldFrame
...
private module UIViewInit
    //! textmacro UIViewInitMacro takes timer
        ...
        set WorldFrame = BlzCreateFrameByType("FRAME", "WorldFrame", ConsoleUIBackdrop,"", 0)
        call BlzFrameSetPoint(WorldFrame, FRAMEPOINT_TOPLEFT, LEFT_BORDER, FRAMEPOINT_TOPLEFT, 0., 0.)
        call BlzFrameSetPoint(WorldFrame, FRAMEPOINT_BOTTOMRIGHT, RIGHT_BORDER, FRAMEPOINT_BOTTOMRIGHT, 0., 0.)
