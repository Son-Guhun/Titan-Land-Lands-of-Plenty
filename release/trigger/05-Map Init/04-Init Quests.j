...
function InitQuests takes nothing returns nothing
    ...
    // Player Colors
    set quest_text = "|c00ff0303red = 1|r
|c000042ffblue = 2|r
|c001ce6b9teal = 3|r
|c00540081purple = 4|r
|c00fffc01yellow = 5|r
...
"
    ...
    // Abilities
    set quest_text = "You can customize your heroes' abilities, including units that were made into heroes using the |cffffff00-makehero|r command. Abilities compatbile with these commands have a special code at the end of their name, written in gray.
...
"
    ...
    // Animations
    set quest_text = "In Warcraft III, there are animation names and animation tags. A model can have different sets of animations by using animation tags. For example, the Demon Hunter has 2 animation sets, one for its normal form and another for its demonic form. The demonic form uses the 'alternate' tag.
...
"
    ...
    // Animation
    set quest_text = "|cffff0000Animation commands:|r
...
"
    ...
    // Controller
    set quest_text = "You can use the special unit Deco Modifier Controller to control up to 48 units using the same abilities used by decorations. Additionally, when selecting a Controller, many commands (such as |cffffff00'rgb|r) will affect all units you are currently controlling, instead of the Controller itself.
...
"
    ...
    // Titan Commands 1
    set quest_text = "|cffffff00-kick|r (color or #)
...
"
    ...
    // Titan Commands 2
    set quest_text = "|cffffff00-water|r (red) [green] [blue] [alpha]
...
"
    ...
    // Unit Commands
    set quest_text = "|cffff0000Unit Commands:|r
...
"
    ...
    set quest_text = "|cffff0000Unit Modification Commands:|r
...
"
    ...
    // Player Commands
    set quest_text = "|cffff0000Alliance Commands:|r (Color names are case-insensitive for all commands. You can use a player number instead.)
...
"
    ...
    // Camera Commands
    set quest_text = "|cffffff00-zoom|r (value)
...
"
    ...
    set quest_text = "|cffff0000Deco Special Commands:|r
...
"
    ...
    // Autoname
    set quest_text = "Autoname allows you to automatically set your player name as the name of the last unit you selected. Only units with custom user-defined names will be detected by the autoname system. Use the |cffffff00-nameunit|r command to give a unit a custom name.
...
"
    ...
    // SaveNLoad Commands
    set quest_text = "|cffffff00-save (SaveName)|r
...
"
    ...
    set quest_text = "GPS, for short, this system modifies the patrol ability, allowing you to have multiple patrol check points. To set a new checkpoint, simply use the patrol ability again (no shift-click).
...
"
    ...
    set quest_text = "Want to support the project? You can do so at: |cffffcc00ko-fi.com/songuhun|r
...
"
    ...
    // Titan Land Creators
    set quest_text = "- Guhun (Creator & Director)
...
"
    ...
    // Titan Land Creators
    set quest_text = "-MetalWarrior (Original Creator)
...
"
    ...
    // Model Credits 1
    set quest_text = "|cff00b300The Hive Workshop:|r
...
"
    ...
    // Coding and Tools
    set quest_text = "MindWorX => Sharpcraft World Editor
Magos => Model Editor
Alexei => Mdlvis
Guesst => MDX squisher
Spec => BLP Laboratory
