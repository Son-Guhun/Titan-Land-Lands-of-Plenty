...
real bbbb = 0.0900987653465435643545
endglobals
...
//Implemented from module Table___hashtablem:
    ...
    function s__Table_create takes nothing returns integer
        local integer this= (LoadInteger(Table___ht, (((8))), (0))) // INLINED!!
       
        if this == 0 then
            set this=Table___more + 1
            set Table___more=this
        else
            call SaveInteger(Table___ht, (((8))), (0), ( (LoadInteger(Table___ht, (((8))), (this))))) // INLINED!!
            call RemoveSavedInteger(Table___ht, (((8))), (this)) //Clear hashed memory // INLINED!!
        endif
    ...
    function s__Table_destroy takes integer this returns nothing
        ...
        call SaveInteger(Table___ht, (((8))), (this), ( (LoadInteger(Table___ht, (((8))), (0))))) // INLINED!!
        call SaveInteger(Table___ht, (((8))), (0), ( this)) // INLINED!!
    endfunction
...
//ignored textmacro command: TABLE_BC_STRUCTS()
    ...
    function s__TableArray__staticgetindex takes integer array_size returns integer
        local integer tb= (LoadInteger(Table___ht, (((6))), (array_size))) // INLINED!!
        ...
        call SaveInteger(Table___ht, (((6))), (this), ( array_size)) //This remembers the array size // INLINED!!
        return this
    endfunction
   
    //Returns the size of the TableArray
    function s__TableArray__get_size takes integer this returns integer
        return (LoadInteger(Table___ht, (((6))), (this))) // INLINED!!
    endfunction
    ...
    function s__TableArray_destroy takes integer this returns nothing
        local integer tb= (LoadInteger(Table___ht, (((6))), ((LoadInteger(Table___ht, (((6))), ((this))))))) // INLINED!!
       
       
        if tb == 0 then
            //Create a Table to index recycled instances with their array size
            set tb=s__Table_create()
            call SaveInteger(Table___ht, (((6))), ((LoadInteger(Table___ht, (((6))), ((this))))), ( tb)) // INLINED!!
        endif
       
        call RemoveSavedInteger(Table___ht, (((6))), (this)) //Clear the array size from hash memory // INLINED!!
    ...
    function s__TableArray_flush takes integer this returns nothing
        ...
        set s__TableArray_tempEnd=this + (LoadInteger(Table___ht, (((6))), ((this)))) // INLINED!!
        call ForForce(bj_FORCE_PLAYER[0], function s__TableArray_clean)
...
function s__Args_setReal takes integer i,real value returns nothing
    local integer stack= (LoadInteger(ConstTable___ht, ((((20)))), (i))) // INLINED!!
    local integer current
    if stack == 0 then
        set stack=s__Table_create()
        call SaveInteger(ConstTable___ht, ((((20)))), (i), ( stack)) // INLINED!!
        call SaveInteger(Table___ht, (stack), (- 1), ( 0)) // INLINED!!
        set current=0
    else
        set current=(LoadInteger(Table___ht, (stack), (- 1))) + 1 // INLINED!!
...
function s__Args_getReal takes integer i returns real
    return (LoadReal(Table___ht, ((((LoadInteger(ConstTable___ht, ((((20)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((20)))), (i)))), (- 1)))))) // INLINED!!
endfunction
...
function s__Args_realGetDepth takes integer i returns integer
    return (LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((20)))), (i)))), (- 1))) + 1 // INLINED!!
endfunction

function s__Args_realDig takes integer i,integer depth returns real
    return (LoadReal(Table___ht, ((((LoadInteger(ConstTable___ht, ((((20)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((20)))), (i)))), (- 1))) - depth))) // INLINED!!
endfunction

function s__Args_realDestroyStack takes integer whichStack returns nothing
    call s__Table_destroy((LoadInteger(ConstTable___ht, ((((20)))), (whichStack)))) // INLINED!!
endfunction
...
function s__Args_setInteger takes integer i,integer value returns nothing
    local integer stack= (LoadInteger(ConstTable___ht, ((((22)))), (i))) // INLINED!!
    local integer current
    if stack == 0 then
        set stack=s__Table_create()
        call SaveInteger(ConstTable___ht, ((((22)))), (i), ( stack)) // INLINED!!
        call SaveInteger(Table___ht, (stack), (- 1), ( 0)) // INLINED!!
        set current=0
    else
        set current=(LoadInteger(Table___ht, (stack), (- 1))) + 1 // INLINED!!
...
function s__Args_getInteger takes integer i returns integer
    return (LoadInteger(Table___ht, ((((LoadInteger(ConstTable___ht, ((((22)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((22)))), (i)))), (- 1)))))) // INLINED!!
endfunction
...
function s__Args_integerGetDepth takes integer i returns integer
    return (LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((22)))), (i)))), (- 1))) + 1 // INLINED!!
endfunction

function s__Args_integerDig takes integer i,integer depth returns integer
    return (LoadInteger(Table___ht, ((((LoadInteger(ConstTable___ht, ((((22)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((22)))), (i)))), (- 1))) - depth))) // INLINED!!
endfunction

function s__Args_integerDestroyStack takes integer whichStack returns nothing
    call s__Table_destroy((LoadInteger(ConstTable___ht, ((((22)))), (whichStack)))) // INLINED!!
endfunction
...
function s__Args_setBoolean takes integer i,boolean value returns nothing
    local integer stack= (LoadInteger(ConstTable___ht, ((((24)))), (i))) // INLINED!!
    local integer current
    if stack == 0 then
        set stack=s__Table_create()
        call SaveInteger(ConstTable___ht, ((((24)))), (i), ( stack)) // INLINED!!
        call SaveInteger(Table___ht, (stack), (- 1), ( 0)) // INLINED!!
        set current=0
    else
        set current=(LoadInteger(Table___ht, (stack), (- 1))) + 1 // INLINED!!
...
function s__Args_getBoolean takes integer i returns boolean
    return (LoadBoolean(Table___ht, ((((LoadInteger(ConstTable___ht, ((((24)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((24)))), (i)))), (- 1)))))) // INLINED!!
endfunction
...
function s__Args_booleanGetDepth takes integer i returns integer
    return (LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((24)))), (i)))), (- 1))) + 1 // INLINED!!
endfunction

function s__Args_booleanDig takes integer i,integer depth returns boolean
    return (LoadBoolean(Table___ht, ((((LoadInteger(ConstTable___ht, ((((24)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((24)))), (i)))), (- 1))) - depth))) // INLINED!!
endfunction

function s__Args_booleanDestroyStack takes integer whichStack returns nothing
    call s__Table_destroy((LoadInteger(ConstTable___ht, ((((24)))), (whichStack)))) // INLINED!!
endfunction
...
function s__Args_setString takes integer i,string value returns nothing
    local integer stack= (LoadInteger(ConstTable___ht, ((((26)))), (i))) // INLINED!!
    local integer current
    if stack == 0 then
        set stack=s__Table_create()
        call SaveInteger(ConstTable___ht, ((((26)))), (i), ( stack)) // INLINED!!
        call SaveInteger(Table___ht, (stack), (- 1), ( 0)) // INLINED!!
        set current=0
    else
        set current=(LoadInteger(Table___ht, (stack), (- 1))) + 1 // INLINED!!
...
function s__Args_getString takes integer i returns string
    return (LoadStr(Table___ht, ((((LoadInteger(ConstTable___ht, ((((26)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((26)))), (i)))), (- 1)))))) // INLINED!!
endfunction
...
function s__Args_stringGetDepth takes integer i returns integer
    return (LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((26)))), (i)))), (- 1))) + 1 // INLINED!!
endfunction

function s__Args_stringDig takes integer i,integer depth returns string
    return (LoadStr(Table___ht, ((((LoadInteger(ConstTable___ht, ((((26)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((26)))), (i)))), (- 1))) - depth))) // INLINED!!
endfunction

function s__Args_stringDestroyStack takes integer whichStack returns nothing
    call s__Table_destroy((LoadInteger(ConstTable___ht, ((((26)))), (whichStack)))) // INLINED!!
endfunction
...
function s__Args_getPlayer takes integer i returns player
    return (LoadPlayerHandle(Table___ht, ((((LoadInteger(ConstTable___ht, ((((28)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((28)))), (i)))), (- 1)))))) // INLINED!!
endfunction
...
function s__Args_playerSet takes integer i,player value returns nothing
    call s__Args_setAgent((28) , (i ) , ( value)) // INLINED!!
endfunction
...
function s__Args_playerFree takes integer i returns nothing
    call s__Args_freeHandle((28) , (i)) // INLINED!!
endfunction

// Advanced methods
function s__Args_playerGetDepth takes integer i returns integer
    return (LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((28)))), (i)))), (- 1))) + 1 // INLINED!!
endfunction

function s__Args_playerDig takes integer i,integer depth returns player
    return (LoadPlayerHandle(Table___ht, ((((LoadInteger(ConstTable___ht, ((((28)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((28)))), (i)))), (- 1))) - depth))) // INLINED!!
endfunction

function s__Args_playerDestroyStack takes integer whichStack returns nothing
    call s__Table_destroy((LoadInteger(ConstTable___ht, ((((28)))), (whichStack)))) // INLINED!!
endfunction
...
function s__Args_getWidget takes integer i returns widget
    return (LoadWidgetHandle(Table___ht, ((((LoadInteger(ConstTable___ht, ((((30)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((30)))), (i)))), (- 1)))))) // INLINED!!
endfunction
...
function s__Args_widgetSet takes integer i,widget value returns nothing
    call s__Args_setAgent((30) , (i ) , ( value)) // INLINED!!
endfunction
...
function s__Args_widgetFree takes integer i returns nothing
    call s__Args_freeHandle((30) , (i)) // INLINED!!
endfunction

// Advanced methods
function s__Args_widgetGetDepth takes integer i returns integer
    return (LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((30)))), (i)))), (- 1))) + 1 // INLINED!!
endfunction

function s__Args_widgetDig takes integer i,integer depth returns widget
    return (LoadWidgetHandle(Table___ht, ((((LoadInteger(ConstTable___ht, ((((30)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((30)))), (i)))), (- 1))) - depth))) // INLINED!!
endfunction

function s__Args_widgetDestroyStack takes integer whichStack returns nothing
    call s__Table_destroy((LoadInteger(ConstTable___ht, ((((30)))), (whichStack)))) // INLINED!!
endfunction
...
function s__Args_getDestructable takes integer i returns destructable
    return (LoadDestructableHandle(Table___ht, ((((LoadInteger(ConstTable___ht, ((((32)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((32)))), (i)))), (- 1)))))) // INLINED!!
endfunction
...
function s__Args_destructableSet takes integer i,destructable value returns nothing
    call s__Args_setAgent((32) , (i ) , ( value)) // INLINED!!
endfunction
...
function s__Args_destructableFree takes integer i returns nothing
    call s__Args_freeHandle((32) , (i)) // INLINED!!
endfunction

// Advanced methods
function s__Args_destructableGetDepth takes integer i returns integer
    return (LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((32)))), (i)))), (- 1))) + 1 // INLINED!!
endfunction

function s__Args_destructableDig takes integer i,integer depth returns destructable
    return (LoadDestructableHandle(Table___ht, ((((LoadInteger(ConstTable___ht, ((((32)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((32)))), (i)))), (- 1))) - depth))) // INLINED!!
endfunction

function s__Args_destructableDestroyStack takes integer whichStack returns nothing
    call s__Table_destroy((LoadInteger(ConstTable___ht, ((((32)))), (whichStack)))) // INLINED!!
endfunction
...
function s__Args_getItem takes integer i returns item
    return (LoadItemHandle(Table___ht, ((((LoadInteger(ConstTable___ht, ((((34)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((34)))), (i)))), (- 1)))))) // INLINED!!
endfunction
...
function s__Args_itemSet takes integer i,item value returns nothing
    call s__Args_setAgent((34) , (i ) , ( value)) // INLINED!!
endfunction
...
function s__Args_itemFree takes integer i returns nothing
    call s__Args_freeHandle((34) , (i)) // INLINED!!
endfunction

// Advanced methods
function s__Args_itemGetDepth takes integer i returns integer
    return (LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((34)))), (i)))), (- 1))) + 1 // INLINED!!
endfunction

function s__Args_itemDig takes integer i,integer depth returns item
    return (LoadItemHandle(Table___ht, ((((LoadInteger(ConstTable___ht, ((((34)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((34)))), (i)))), (- 1))) - depth))) // INLINED!!
endfunction

function s__Args_itemDestroyStack takes integer whichStack returns nothing
    call s__Table_destroy((LoadInteger(ConstTable___ht, ((((34)))), (whichStack)))) // INLINED!!
endfunction
...
function s__Args_getUnit takes integer i returns unit
    return (LoadUnitHandle(Table___ht, ((((LoadInteger(ConstTable___ht, ((((36)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((36)))), (i)))), (- 1)))))) // INLINED!!
endfunction
...
function s__Args_unitSet takes integer i,unit value returns nothing
    call s__Args_setAgent((36) , (i ) , ( value)) // INLINED!!
endfunction
...
function s__Args_unitFree takes integer i returns nothing
    call s__Args_freeHandle((36) , (i)) // INLINED!!
endfunction

// Advanced methods
function s__Args_unitGetDepth takes integer i returns integer
    return (LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((36)))), (i)))), (- 1))) + 1 // INLINED!!
endfunction

function s__Args_unitDig takes integer i,integer depth returns unit
    return (LoadUnitHandle(Table___ht, ((((LoadInteger(ConstTable___ht, ((((36)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((36)))), (i)))), (- 1))) - depth))) // INLINED!!
endfunction

function s__Args_unitDestroyStack takes integer whichStack returns nothing
    call s__Table_destroy((LoadInteger(ConstTable___ht, ((((36)))), (whichStack)))) // INLINED!!
endfunction
...
function s__Args_getAbility takes integer i returns ability
    return (LoadAbilityHandle(Table___ht, ((((LoadInteger(ConstTable___ht, ((((38)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((38)))), (i)))), (- 1)))))) // INLINED!!
endfunction
...
function s__Args_abilitySet takes integer i,ability value returns nothing
    call s__Args_setAgent((38) , (i ) , ( value)) // INLINED!!
endfunction
...
function s__Args_abilityFree takes integer i returns nothing
    call s__Args_freeHandle((38) , (i)) // INLINED!!
endfunction

// Advanced methods
function s__Args_abilityGetDepth takes integer i returns integer
    return (LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((38)))), (i)))), (- 1))) + 1 // INLINED!!
endfunction

function s__Args_abilityDig takes integer i,integer depth returns ability
    return (LoadAbilityHandle(Table___ht, ((((LoadInteger(ConstTable___ht, ((((38)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((38)))), (i)))), (- 1))) - depth))) // INLINED!!
endfunction

function s__Args_abilityDestroyStack takes integer whichStack returns nothing
    call s__Table_destroy((LoadInteger(ConstTable___ht, ((((38)))), (whichStack)))) // INLINED!!
endfunction
...
function s__Args_getTimer takes integer i returns timer
    return (LoadTimerHandle(Table___ht, ((((LoadInteger(ConstTable___ht, ((((40)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((40)))), (i)))), (- 1)))))) // INLINED!!
endfunction
...
function s__Args_timerSet takes integer i,timer value returns nothing
    call s__Args_setAgent((40) , (i ) , ( value)) // INLINED!!
endfunction
...
function s__Args_timerFree takes integer i returns nothing
    call s__Args_freeHandle((40) , (i)) // INLINED!!
endfunction

// Advanced methods
function s__Args_timerGetDepth takes integer i returns integer
    return (LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((40)))), (i)))), (- 1))) + 1 // INLINED!!
endfunction

function s__Args_timerDig takes integer i,integer depth returns timer
    return (LoadTimerHandle(Table___ht, ((((LoadInteger(ConstTable___ht, ((((40)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((40)))), (i)))), (- 1))) - depth))) // INLINED!!
endfunction

function s__Args_timerDestroyStack takes integer whichStack returns nothing
    call s__Table_destroy((LoadInteger(ConstTable___ht, ((((40)))), (whichStack)))) // INLINED!!
endfunction
...
function s__Args_getTrigger takes integer i returns trigger
    return (LoadTriggerHandle(Table___ht, ((((LoadInteger(ConstTable___ht, ((((42)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((42)))), (i)))), (- 1)))))) // INLINED!!
endfunction
...
function s__Args_triggerSet takes integer i,trigger value returns nothing
    call s__Args_setAgent((42) , (i ) , ( value)) // INLINED!!
endfunction
...
function s__Args_triggerFree takes integer i returns nothing
    call s__Args_freeHandle((42) , (i)) // INLINED!!
endfunction

// Advanced methods
function s__Args_triggerGetDepth takes integer i returns integer
    return (LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((42)))), (i)))), (- 1))) + 1 // INLINED!!
endfunction

function s__Args_triggerDig takes integer i,integer depth returns trigger
    return (LoadTriggerHandle(Table___ht, ((((LoadInteger(ConstTable___ht, ((((42)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((42)))), (i)))), (- 1))) - depth))) // INLINED!!
endfunction

function s__Args_triggerDestroyStack takes integer whichStack returns nothing
    call s__Table_destroy((LoadInteger(ConstTable___ht, ((((42)))), (whichStack)))) // INLINED!!
endfunction
...
function s__Args_getTriggercondition takes integer i returns triggercondition
    return (LoadTriggerConditionHandle(Table___ht, ((((LoadInteger(ConstTable___ht, ((((44)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((44)))), (i)))), (- 1)))))) // INLINED!!
endfunction
...
function s__Args_triggerconditionSet takes integer i,triggercondition value returns nothing
    call s__Args_setAgent((44) , (i ) , ( value)) // INLINED!!
endfunction
...
function s__Args_triggerconditionFree takes integer i returns nothing
    call s__Args_freeHandle((44) , (i)) // INLINED!!
endfunction

// Advanced methods
function s__Args_triggerconditionGetDepth takes integer i returns integer
    return (LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((44)))), (i)))), (- 1))) + 1 // INLINED!!
endfunction

function s__Args_triggerconditionDig takes integer i,integer depth returns triggercondition
    return (LoadTriggerConditionHandle(Table___ht, ((((LoadInteger(ConstTable___ht, ((((44)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((44)))), (i)))), (- 1))) - depth))) // INLINED!!
endfunction

function s__Args_triggerconditionDestroyStack takes integer whichStack returns nothing
    call s__Table_destroy((LoadInteger(ConstTable___ht, ((((44)))), (whichStack)))) // INLINED!!
endfunction
...
function s__Args_getEvent takes integer i returns event
    return (LoadTriggerEventHandle(Table___ht, ((((LoadInteger(ConstTable___ht, ((((46)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((46)))), (i)))), (- 1)))))) // INLINED!!
endfunction
...
function s__Args_eventSet takes integer i,event value returns nothing
    call s__Args_setAgent((46) , (i ) , ( value)) // INLINED!!
endfunction
...
function s__Args_eventFree takes integer i returns nothing
    call s__Args_freeHandle((46) , (i)) // INLINED!!
endfunction

// Advanced methods
function s__Args_eventGetDepth takes integer i returns integer
    return (LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((46)))), (i)))), (- 1))) + 1 // INLINED!!
endfunction

function s__Args_eventDig takes integer i,integer depth returns event
    return (LoadTriggerEventHandle(Table___ht, ((((LoadInteger(ConstTable___ht, ((((46)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((46)))), (i)))), (- 1))) - depth))) // INLINED!!
endfunction

function s__Args_eventDestroyStack takes integer whichStack returns nothing
    call s__Table_destroy((LoadInteger(ConstTable___ht, ((((46)))), (whichStack)))) // INLINED!!
endfunction
...
function s__Args_getForce takes integer i returns force
    return (LoadForceHandle(Table___ht, ((((LoadInteger(ConstTable___ht, ((((48)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((48)))), (i)))), (- 1)))))) // INLINED!!
endfunction
...
function s__Args_forceSet takes integer i,force value returns nothing
    call s__Args_setAgent((48) , (i ) , ( value)) // INLINED!!
endfunction
...
function s__Args_forceFree takes integer i returns nothing
    call s__Args_freeHandle((48) , (i)) // INLINED!!
endfunction

// Advanced methods
function s__Args_forceGetDepth takes integer i returns integer
    return (LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((48)))), (i)))), (- 1))) + 1 // INLINED!!
endfunction

function s__Args_forceDig takes integer i,integer depth returns force
    return (LoadForceHandle(Table___ht, ((((LoadInteger(ConstTable___ht, ((((48)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((48)))), (i)))), (- 1))) - depth))) // INLINED!!
endfunction

function s__Args_forceDestroyStack takes integer whichStack returns nothing
    call s__Table_destroy((LoadInteger(ConstTable___ht, ((((48)))), (whichStack)))) // INLINED!!
endfunction
...
function s__Args_getGroup takes integer i returns group
    return (LoadGroupHandle(Table___ht, ((((LoadInteger(ConstTable___ht, ((((50)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((50)))), (i)))), (- 1)))))) // INLINED!!
endfunction
...
function s__Args_groupSet takes integer i,group value returns nothing
    call s__Args_setAgent((50) , (i ) , ( value)) // INLINED!!
endfunction
...
function s__Args_groupFree takes integer i returns nothing
    call s__Args_freeHandle((50) , (i)) // INLINED!!
endfunction

// Advanced methods
function s__Args_groupGetDepth takes integer i returns integer
    return (LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((50)))), (i)))), (- 1))) + 1 // INLINED!!
endfunction

function s__Args_groupDig takes integer i,integer depth returns group
    return (LoadGroupHandle(Table___ht, ((((LoadInteger(ConstTable___ht, ((((50)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((50)))), (i)))), (- 1))) - depth))) // INLINED!!
endfunction

function s__Args_groupDestroyStack takes integer whichStack returns nothing
    call s__Table_destroy((LoadInteger(ConstTable___ht, ((((50)))), (whichStack)))) // INLINED!!
endfunction
...
function s__Args_getLocation takes integer i returns location
    return (LoadLocationHandle(Table___ht, ((((LoadInteger(ConstTable___ht, ((((52)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((52)))), (i)))), (- 1)))))) // INLINED!!
endfunction
...
function s__Args_locationSet takes integer i,location value returns nothing
    call s__Args_setAgent((52) , (i ) , ( value)) // INLINED!!
endfunction
...
function s__Args_locationFree takes integer i returns nothing
    call s__Args_freeHandle((52) , (i)) // INLINED!!
endfunction

// Advanced methods
function s__Args_locationGetDepth takes integer i returns integer
    return (LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((52)))), (i)))), (- 1))) + 1 // INLINED!!
endfunction

function s__Args_locationDig takes integer i,integer depth returns location
    return (LoadLocationHandle(Table___ht, ((((LoadInteger(ConstTable___ht, ((((52)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((52)))), (i)))), (- 1))) - depth))) // INLINED!!
endfunction

function s__Args_locationDestroyStack takes integer whichStack returns nothing
    call s__Table_destroy((LoadInteger(ConstTable___ht, ((((52)))), (whichStack)))) // INLINED!!
endfunction
...
function s__Args_getRect takes integer i returns rect
    return (LoadRectHandle(Table___ht, ((((LoadInteger(ConstTable___ht, ((((54)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((54)))), (i)))), (- 1)))))) // INLINED!!
endfunction
...
function s__Args_rectSet takes integer i,rect value returns nothing
    call s__Args_setAgent((54) , (i ) , ( value)) // INLINED!!
endfunction
...
function s__Args_rectFree takes integer i returns nothing
    call s__Args_freeHandle((54) , (i)) // INLINED!!
endfunction

// Advanced methods
function s__Args_rectGetDepth takes integer i returns integer
    return (LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((54)))), (i)))), (- 1))) + 1 // INLINED!!
endfunction

function s__Args_rectDig takes integer i,integer depth returns rect
    return (LoadRectHandle(Table___ht, ((((LoadInteger(ConstTable___ht, ((((54)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((54)))), (i)))), (- 1))) - depth))) // INLINED!!
endfunction

function s__Args_rectDestroyStack takes integer whichStack returns nothing
    call s__Table_destroy((LoadInteger(ConstTable___ht, ((((54)))), (whichStack)))) // INLINED!!
endfunction
...
function s__Args_getBoolexpr takes integer i returns boolexpr
    return (LoadBooleanExprHandle(Table___ht, ((((LoadInteger(ConstTable___ht, ((((56)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((56)))), (i)))), (- 1)))))) // INLINED!!
endfunction
...
function s__Args_boolexprSet takes integer i,boolexpr value returns nothing
    call s__Args_setAgent((56) , (i ) , ( value)) // INLINED!!
endfunction
...
function s__Args_boolexprFree takes integer i returns nothing
    call s__Args_freeHandle((56) , (i)) // INLINED!!
endfunction

// Advanced methods
function s__Args_boolexprGetDepth takes integer i returns integer
    return (LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((56)))), (i)))), (- 1))) + 1 // INLINED!!
endfunction

function s__Args_boolexprDig takes integer i,integer depth returns boolexpr
    return (LoadBooleanExprHandle(Table___ht, ((((LoadInteger(ConstTable___ht, ((((56)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((56)))), (i)))), (- 1))) - depth))) // INLINED!!
endfunction

function s__Args_boolexprDestroyStack takes integer whichStack returns nothing
    call s__Table_destroy((LoadInteger(ConstTable___ht, ((((56)))), (whichStack)))) // INLINED!!
endfunction
...
function s__Args_getSound takes integer i returns sound
    return (LoadSoundHandle(Table___ht, ((((LoadInteger(ConstTable___ht, ((((58)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((58)))), (i)))), (- 1)))))) // INLINED!!
endfunction
...
function s__Args_soundSet takes integer i,sound value returns nothing
    call s__Args_setAgent((58) , (i ) , ( value)) // INLINED!!
endfunction
...
function s__Args_soundFree takes integer i returns nothing
    call s__Args_freeHandle((58) , (i)) // INLINED!!
endfunction

// Advanced methods
function s__Args_soundGetDepth takes integer i returns integer
    return (LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((58)))), (i)))), (- 1))) + 1 // INLINED!!
endfunction

function s__Args_soundDig takes integer i,integer depth returns sound
    return (LoadSoundHandle(Table___ht, ((((LoadInteger(ConstTable___ht, ((((58)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((58)))), (i)))), (- 1))) - depth))) // INLINED!!
endfunction

function s__Args_soundDestroyStack takes integer whichStack returns nothing
    call s__Table_destroy((LoadInteger(ConstTable___ht, ((((58)))), (whichStack)))) // INLINED!!
endfunction
...
function s__Args_getEffect takes integer i returns effect
    return (LoadEffectHandle(Table___ht, ((((LoadInteger(ConstTable___ht, ((((60)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((60)))), (i)))), (- 1)))))) // INLINED!!
endfunction
...
function s__Args_effectSet takes integer i,effect value returns nothing
    call s__Args_setAgent((60) , (i ) , ( value)) // INLINED!!
endfunction
...
function s__Args_effectFree takes integer i returns nothing
    call s__Args_freeHandle((60) , (i)) // INLINED!!
endfunction

// Advanced methods
function s__Args_effectGetDepth takes integer i returns integer
    return (LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((60)))), (i)))), (- 1))) + 1 // INLINED!!
endfunction

function s__Args_effectDig takes integer i,integer depth returns effect
    return (LoadEffectHandle(Table___ht, ((((LoadInteger(ConstTable___ht, ((((60)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((60)))), (i)))), (- 1))) - depth))) // INLINED!!
endfunction

function s__Args_effectDestroyStack takes integer whichStack returns nothing
    call s__Table_destroy((LoadInteger(ConstTable___ht, ((((60)))), (whichStack)))) // INLINED!!
endfunction
...
function s__Args_getQuest takes integer i returns quest
    return (LoadQuestHandle(Table___ht, ((((LoadInteger(ConstTable___ht, ((((62)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((62)))), (i)))), (- 1)))))) // INLINED!!
endfunction
...
function s__Args_questSet takes integer i,quest value returns nothing
    call s__Args_setAgent((62) , (i ) , ( value)) // INLINED!!
endfunction
...
function s__Args_questFree takes integer i returns nothing
    call s__Args_freeHandle((62) , (i)) // INLINED!!
endfunction

// Advanced methods
function s__Args_questGetDepth takes integer i returns integer
    return (LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((62)))), (i)))), (- 1))) + 1 // INLINED!!
endfunction

function s__Args_questDig takes integer i,integer depth returns quest
    return (LoadQuestHandle(Table___ht, ((((LoadInteger(ConstTable___ht, ((((62)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((62)))), (i)))), (- 1))) - depth))) // INLINED!!
endfunction

function s__Args_questDestroyStack takes integer whichStack returns nothing
    call s__Table_destroy((LoadInteger(ConstTable___ht, ((((62)))), (whichStack)))) // INLINED!!
endfunction
...
function s__Args_getQuestitem takes integer i returns questitem
    return (LoadQuestItemHandle(Table___ht, ((((LoadInteger(ConstTable___ht, ((((64)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((64)))), (i)))), (- 1)))))) // INLINED!!
endfunction
...
function s__Args_questitemSet takes integer i,questitem value returns nothing
    call s__Args_setAgent((64) , (i ) , ( value)) // INLINED!!
endfunction
...
function s__Args_questitemFree takes integer i returns nothing
    call s__Args_freeHandle((64) , (i)) // INLINED!!
endfunction

// Advanced methods
function s__Args_questitemGetDepth takes integer i returns integer
    return (LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((64)))), (i)))), (- 1))) + 1 // INLINED!!
endfunction

function s__Args_questitemDig takes integer i,integer depth returns questitem
    return (LoadQuestItemHandle(Table___ht, ((((LoadInteger(ConstTable___ht, ((((64)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((64)))), (i)))), (- 1))) - depth))) // INLINED!!
endfunction

function s__Args_questitemDestroyStack takes integer whichStack returns nothing
    call s__Table_destroy((LoadInteger(ConstTable___ht, ((((64)))), (whichStack)))) // INLINED!!
endfunction
...
function s__Args_getDefeatcondition takes integer i returns defeatcondition
    return (LoadDefeatConditionHandle(Table___ht, ((((LoadInteger(ConstTable___ht, ((((66)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((66)))), (i)))), (- 1)))))) // INLINED!!
endfunction
...
function s__Args_defeatconditionSet takes integer i,defeatcondition value returns nothing
    call s__Args_setAgent((66) , (i ) , ( value)) // INLINED!!
endfunction
...
function s__Args_defeatconditionFree takes integer i returns nothing
    call s__Args_freeHandle((66) , (i)) // INLINED!!
endfunction

// Advanced methods
function s__Args_defeatconditionGetDepth takes integer i returns integer
    return (LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((66)))), (i)))), (- 1))) + 1 // INLINED!!
endfunction

function s__Args_defeatconditionDig takes integer i,integer depth returns defeatcondition
    return (LoadDefeatConditionHandle(Table___ht, ((((LoadInteger(ConstTable___ht, ((((66)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((66)))), (i)))), (- 1))) - depth))) // INLINED!!
endfunction

function s__Args_defeatconditionDestroyStack takes integer whichStack returns nothing
    call s__Table_destroy((LoadInteger(ConstTable___ht, ((((66)))), (whichStack)))) // INLINED!!
endfunction
...
function s__Args_getTimerdialog takes integer i returns timerdialog
    return (LoadTimerDialogHandle(Table___ht, ((((LoadInteger(ConstTable___ht, ((((68)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((68)))), (i)))), (- 1)))))) // INLINED!!
endfunction
...
function s__Args_timerdialogSet takes integer i,timerdialog value returns nothing
    call s__Args_setAgent((68) , (i ) , ( value)) // INLINED!!
endfunction
...
function s__Args_timerdialogFree takes integer i returns nothing
    call s__Args_freeHandle((68) , (i)) // INLINED!!
endfunction

// Advanced methods
function s__Args_timerdialogGetDepth takes integer i returns integer
    return (LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((68)))), (i)))), (- 1))) + 1 // INLINED!!
endfunction

function s__Args_timerdialogDig takes integer i,integer depth returns timerdialog
    return (LoadTimerDialogHandle(Table___ht, ((((LoadInteger(ConstTable___ht, ((((68)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((68)))), (i)))), (- 1))) - depth))) // INLINED!!
endfunction

function s__Args_timerdialogDestroyStack takes integer whichStack returns nothing
    call s__Table_destroy((LoadInteger(ConstTable___ht, ((((68)))), (whichStack)))) // INLINED!!
endfunction
...
function s__Args_getLeaderboard takes integer i returns leaderboard
    return (LoadLeaderboardHandle(Table___ht, ((((LoadInteger(ConstTable___ht, ((((70)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((70)))), (i)))), (- 1)))))) // INLINED!!
endfunction
...
function s__Args_leaderboardSet takes integer i,leaderboard value returns nothing
    call s__Args_setAgent((70) , (i ) , ( value)) // INLINED!!
endfunction
...
function s__Args_leaderboardFree takes integer i returns nothing
    call s__Args_freeHandle((70) , (i)) // INLINED!!
endfunction

// Advanced methods
function s__Args_leaderboardGetDepth takes integer i returns integer
    return (LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((70)))), (i)))), (- 1))) + 1 // INLINED!!
endfunction

function s__Args_leaderboardDig takes integer i,integer depth returns leaderboard
    return (LoadLeaderboardHandle(Table___ht, ((((LoadInteger(ConstTable___ht, ((((70)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((70)))), (i)))), (- 1))) - depth))) // INLINED!!
endfunction

function s__Args_leaderboardDestroyStack takes integer whichStack returns nothing
    call s__Table_destroy((LoadInteger(ConstTable___ht, ((((70)))), (whichStack)))) // INLINED!!
endfunction
...
function s__Args_getMultiboard takes integer i returns multiboard
    return (LoadMultiboardHandle(Table___ht, ((((LoadInteger(ConstTable___ht, ((((72)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((72)))), (i)))), (- 1)))))) // INLINED!!
endfunction
...
function s__Args_multiboardSet takes integer i,multiboard value returns nothing
    call s__Args_setAgent((72) , (i ) , ( value)) // INLINED!!
endfunction
...
function s__Args_multiboardFree takes integer i returns nothing
    call s__Args_freeHandle((72) , (i)) // INLINED!!
endfunction

// Advanced methods
function s__Args_multiboardGetDepth takes integer i returns integer
    return (LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((72)))), (i)))), (- 1))) + 1 // INLINED!!
endfunction

function s__Args_multiboardDig takes integer i,integer depth returns multiboard
    return (LoadMultiboardHandle(Table___ht, ((((LoadInteger(ConstTable___ht, ((((72)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((72)))), (i)))), (- 1))) - depth))) // INLINED!!
endfunction

function s__Args_multiboardDestroyStack takes integer whichStack returns nothing
    call s__Table_destroy((LoadInteger(ConstTable___ht, ((((72)))), (whichStack)))) // INLINED!!
endfunction
...
function s__Args_getMultiboarditem takes integer i returns multiboarditem
    return (LoadMultiboardItemHandle(Table___ht, ((((LoadInteger(ConstTable___ht, ((((74)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((74)))), (i)))), (- 1)))))) // INLINED!!
endfunction
...
function s__Args_multiboarditemSet takes integer i,multiboarditem value returns nothing
    call s__Args_setAgent((74) , (i ) , ( value)) // INLINED!!
endfunction
...
function s__Args_multiboarditemFree takes integer i returns nothing
    call s__Args_freeHandle((74) , (i)) // INLINED!!
endfunction

// Advanced methods
function s__Args_multiboarditemGetDepth takes integer i returns integer
    return (LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((74)))), (i)))), (- 1))) + 1 // INLINED!!
endfunction

function s__Args_multiboarditemDig takes integer i,integer depth returns multiboarditem
    return (LoadMultiboardItemHandle(Table___ht, ((((LoadInteger(ConstTable___ht, ((((74)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((74)))), (i)))), (- 1))) - depth))) // INLINED!!
endfunction

function s__Args_multiboarditemDestroyStack takes integer whichStack returns nothing
    call s__Table_destroy((LoadInteger(ConstTable___ht, ((((74)))), (whichStack)))) // INLINED!!
endfunction
...
function s__Args_getTrackable takes integer i returns trackable
    return (LoadTrackableHandle(Table___ht, ((((LoadInteger(ConstTable___ht, ((((76)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((76)))), (i)))), (- 1)))))) // INLINED!!
endfunction
...
function s__Args_trackableSet takes integer i,trackable value returns nothing
    call s__Args_setAgent((76) , (i ) , ( value)) // INLINED!!
endfunction
...
function s__Args_trackableFree takes integer i returns nothing
    call s__Args_freeHandle((76) , (i)) // INLINED!!
endfunction

// Advanced methods
function s__Args_trackableGetDepth takes integer i returns integer
    return (LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((76)))), (i)))), (- 1))) + 1 // INLINED!!
endfunction

function s__Args_trackableDig takes integer i,integer depth returns trackable
    return (LoadTrackableHandle(Table___ht, ((((LoadInteger(ConstTable___ht, ((((76)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((76)))), (i)))), (- 1))) - depth))) // INLINED!!
endfunction

function s__Args_trackableDestroyStack takes integer whichStack returns nothing
    call s__Table_destroy((LoadInteger(ConstTable___ht, ((((76)))), (whichStack)))) // INLINED!!
endfunction
...
function s__Args_getDialog takes integer i returns dialog
    return (LoadDialogHandle(Table___ht, ((((LoadInteger(ConstTable___ht, ((((78)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((78)))), (i)))), (- 1)))))) // INLINED!!
endfunction
...
function s__Args_dialogSet takes integer i,dialog value returns nothing
    call s__Args_setAgent((78) , (i ) , ( value)) // INLINED!!
endfunction
...
function s__Args_dialogFree takes integer i returns nothing
    call s__Args_freeHandle((78) , (i)) // INLINED!!
endfunction

// Advanced methods
function s__Args_dialogGetDepth takes integer i returns integer
    return (LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((78)))), (i)))), (- 1))) + 1 // INLINED!!
endfunction

function s__Args_dialogDig takes integer i,integer depth returns dialog
    return (LoadDialogHandle(Table___ht, ((((LoadInteger(ConstTable___ht, ((((78)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((78)))), (i)))), (- 1))) - depth))) // INLINED!!
endfunction

function s__Args_dialogDestroyStack takes integer whichStack returns nothing
    call s__Table_destroy((LoadInteger(ConstTable___ht, ((((78)))), (whichStack)))) // INLINED!!
endfunction
...
function s__Args_getButton takes integer i returns button
    return (LoadButtonHandle(Table___ht, ((((LoadInteger(ConstTable___ht, ((((80)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((80)))), (i)))), (- 1)))))) // INLINED!!
endfunction
...
function s__Args_buttonSet takes integer i,button value returns nothing
    call s__Args_setAgent((80) , (i ) , ( value)) // INLINED!!
endfunction
...
function s__Args_buttonFree takes integer i returns nothing
    call s__Args_freeHandle((80) , (i)) // INLINED!!
endfunction

// Advanced methods
function s__Args_buttonGetDepth takes integer i returns integer
    return (LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((80)))), (i)))), (- 1))) + 1 // INLINED!!
endfunction

function s__Args_buttonDig takes integer i,integer depth returns button
    return (LoadButtonHandle(Table___ht, ((((LoadInteger(ConstTable___ht, ((((80)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((80)))), (i)))), (- 1))) - depth))) // INLINED!!
endfunction

function s__Args_buttonDestroyStack takes integer whichStack returns nothing
    call s__Table_destroy((LoadInteger(ConstTable___ht, ((((80)))), (whichStack)))) // INLINED!!
endfunction
...
function s__Args_getRegion takes integer i returns region
    return (LoadRegionHandle(Table___ht, ((((LoadInteger(ConstTable___ht, ((((82)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((82)))), (i)))), (- 1)))))) // INLINED!!
endfunction
...
function s__Args_regionSet takes integer i,region value returns nothing
    call s__Args_setAgent((82) , (i ) , ( value)) // INLINED!!
endfunction
...
function s__Args_regionFree takes integer i returns nothing
    call s__Args_freeHandle((82) , (i)) // INLINED!!
endfunction

// Advanced methods
function s__Args_regionGetDepth takes integer i returns integer
    return (LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((82)))), (i)))), (- 1))) + 1 // INLINED!!
endfunction

function s__Args_regionDig takes integer i,integer depth returns region
    return (LoadRegionHandle(Table___ht, ((((LoadInteger(ConstTable___ht, ((((82)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((82)))), (i)))), (- 1))) - depth))) // INLINED!!
endfunction

function s__Args_regionDestroyStack takes integer whichStack returns nothing
    call s__Table_destroy((LoadInteger(ConstTable___ht, ((((82)))), (whichStack)))) // INLINED!!
endfunction
...
function s__Args_getFogmodifier takes integer i returns fogmodifier
    return (LoadFogModifierHandle(Table___ht, ((((LoadInteger(ConstTable___ht, ((((84)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((84)))), (i)))), (- 1)))))) // INLINED!!
endfunction
...
function s__Args_fogmodifierSet takes integer i,fogmodifier value returns nothing
    call s__Args_setAgent((84) , (i ) , ( value)) // INLINED!!
endfunction
...
function s__Args_fogmodifierFree takes integer i returns nothing
    call s__Args_freeHandle((84) , (i)) // INLINED!!
endfunction

// Advanced methods
function s__Args_fogmodifierGetDepth takes integer i returns integer
    return (LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((84)))), (i)))), (- 1))) + 1 // INLINED!!
endfunction

function s__Args_fogmodifierDig takes integer i,integer depth returns fogmodifier
    return (LoadFogModifierHandle(Table___ht, ((((LoadInteger(ConstTable___ht, ((((84)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((84)))), (i)))), (- 1))) - depth))) // INLINED!!
endfunction

function s__Args_fogmodifierDestroyStack takes integer whichStack returns nothing
    call s__Table_destroy((LoadInteger(ConstTable___ht, ((((84)))), (whichStack)))) // INLINED!!
endfunction
...
function s__Args_getHashtable takes integer i returns hashtable
    return (LoadHashtableHandle(Table___ht, ((((LoadInteger(ConstTable___ht, ((((86)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((86)))), (i)))), (- 1)))))) // INLINED!!
endfunction
...
function s__Args_hashtableSet takes integer i,hashtable value returns nothing
    call s__Args_setAgent((86) , (i ) , ( value)) // INLINED!!
endfunction
...
function s__Args_hashtableFree takes integer i returns nothing
    call s__Args_freeHandle((86) , (i)) // INLINED!!
endfunction

// Advanced methods
function s__Args_hashtableGetDepth takes integer i returns integer
    return (LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((86)))), (i)))), (- 1))) + 1 // INLINED!!
endfunction

function s__Args_hashtableDig takes integer i,integer depth returns hashtable
    return (LoadHashtableHandle(Table___ht, ((((LoadInteger(ConstTable___ht, ((((86)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((86)))), (i)))), (- 1))) - depth))) // INLINED!!
endfunction

function s__Args_hashtableDestroyStack takes integer whichStack returns nothing
    call s__Table_destroy((LoadInteger(ConstTable___ht, ((((86)))), (whichStack)))) // INLINED!!
endfunction
...
function s__Args_getTriggeraction takes integer i returns triggeraction
    return (LoadTriggerActionHandle(Table___ht, ((((LoadInteger(ConstTable___ht, ((((88)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((88)))), (i)))), (- 1)))))) // INLINED!!
endfunction
...
function s__Args_triggeractionSet takes integer i,triggeraction value returns nothing
    call s__Args_setHandle((88) , (i ) , ( value)) // INLINED!!
endfunction
...
function s__Args_triggeractionFree takes integer i returns nothing
    call s__Args_freeHandle((88) , (i)) // INLINED!!
endfunction

// Advanced methods
function s__Args_triggeractionGetDepth takes integer i returns integer
    return (LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((88)))), (i)))), (- 1))) + 1 // INLINED!!
endfunction

function s__Args_triggeractionDig takes integer i,integer depth returns triggeraction
    return (LoadTriggerActionHandle(Table___ht, ((((LoadInteger(ConstTable___ht, ((((88)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((88)))), (i)))), (- 1))) - depth))) // INLINED!!
endfunction

function s__Args_triggeractionDestroyStack takes integer whichStack returns nothing
    call s__Table_destroy((LoadInteger(ConstTable___ht, ((((88)))), (whichStack)))) // INLINED!!
endfunction
...
function s__Args_getUnitpool takes integer i returns unitpool
    return (LoadUnitPoolHandle(Table___ht, ((((LoadInteger(ConstTable___ht, ((((90)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((90)))), (i)))), (- 1)))))) // INLINED!!
endfunction
...
function s__Args_unitpoolSet takes integer i,unitpool value returns nothing
    call s__Args_setHandle((90) , (i ) , ( value)) // INLINED!!
endfunction
...
function s__Args_unitpoolFree takes integer i returns nothing
    call s__Args_freeHandle((90) , (i)) // INLINED!!
endfunction

// Advanced methods
function s__Args_unitpoolGetDepth takes integer i returns integer
    return (LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((90)))), (i)))), (- 1))) + 1 // INLINED!!
endfunction

function s__Args_unitpoolDig takes integer i,integer depth returns unitpool
    return (LoadUnitPoolHandle(Table___ht, ((((LoadInteger(ConstTable___ht, ((((90)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((90)))), (i)))), (- 1))) - depth))) // INLINED!!
endfunction

function s__Args_unitpoolDestroyStack takes integer whichStack returns nothing
    call s__Table_destroy((LoadInteger(ConstTable___ht, ((((90)))), (whichStack)))) // INLINED!!
endfunction
...
function s__Args_getItempool takes integer i returns itempool
    return (LoadItemPoolHandle(Table___ht, ((((LoadInteger(ConstTable___ht, ((((92)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((92)))), (i)))), (- 1)))))) // INLINED!!
endfunction
...
function s__Args_itempoolSet takes integer i,itempool value returns nothing
    call s__Args_setHandle((92) , (i ) , ( value)) // INLINED!!
endfunction
...
function s__Args_itempoolFree takes integer i returns nothing
    call s__Args_freeHandle((92) , (i)) // INLINED!!
endfunction

// Advanced methods
function s__Args_itempoolGetDepth takes integer i returns integer
    return (LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((92)))), (i)))), (- 1))) + 1 // INLINED!!
endfunction

function s__Args_itempoolDig takes integer i,integer depth returns itempool
    return (LoadItemPoolHandle(Table___ht, ((((LoadInteger(ConstTable___ht, ((((92)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((92)))), (i)))), (- 1))) - depth))) // INLINED!!
endfunction

function s__Args_itempoolDestroyStack takes integer whichStack returns nothing
    call s__Table_destroy((LoadInteger(ConstTable___ht, ((((92)))), (whichStack)))) // INLINED!!
endfunction
...
function s__Args_getTexttag takes integer i returns texttag
    return (LoadTextTagHandle(Table___ht, ((((LoadInteger(ConstTable___ht, ((((94)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((94)))), (i)))), (- 1)))))) // INLINED!!
endfunction
...
function s__Args_texttagSet takes integer i,texttag value returns nothing
    call s__Args_setHandle((94) , (i ) , ( value)) // INLINED!!
endfunction
...
function s__Args_texttagFree takes integer i returns nothing
    call s__Args_freeHandle((94) , (i)) // INLINED!!
endfunction

// Advanced methods
function s__Args_texttagGetDepth takes integer i returns integer
    return (LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((94)))), (i)))), (- 1))) + 1 // INLINED!!
endfunction

function s__Args_texttagDig takes integer i,integer depth returns texttag
    return (LoadTextTagHandle(Table___ht, ((((LoadInteger(ConstTable___ht, ((((94)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((94)))), (i)))), (- 1))) - depth))) // INLINED!!
endfunction

function s__Args_texttagDestroyStack takes integer whichStack returns nothing
    call s__Table_destroy((LoadInteger(ConstTable___ht, ((((94)))), (whichStack)))) // INLINED!!
endfunction
...
function s__Args_getLightning takes integer i returns lightning
    return (LoadLightningHandle(Table___ht, ((((LoadInteger(ConstTable___ht, ((((96)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((96)))), (i)))), (- 1)))))) // INLINED!!
endfunction
...
function s__Args_lightningSet takes integer i,lightning value returns nothing
    call s__Args_setHandle((96) , (i ) , ( value)) // INLINED!!
endfunction
...
function s__Args_lightningFree takes integer i returns nothing
    call s__Args_freeHandle((96) , (i)) // INLINED!!
endfunction

// Advanced methods
function s__Args_lightningGetDepth takes integer i returns integer
    return (LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((96)))), (i)))), (- 1))) + 1 // INLINED!!
endfunction

function s__Args_lightningDig takes integer i,integer depth returns lightning
    return (LoadLightningHandle(Table___ht, ((((LoadInteger(ConstTable___ht, ((((96)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((96)))), (i)))), (- 1))) - depth))) // INLINED!!
endfunction

function s__Args_lightningDestroyStack takes integer whichStack returns nothing
    call s__Table_destroy((LoadInteger(ConstTable___ht, ((((96)))), (whichStack)))) // INLINED!!
endfunction
...
function s__Args_getImage takes integer i returns image
    return (LoadImageHandle(Table___ht, ((((LoadInteger(ConstTable___ht, ((((98)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((98)))), (i)))), (- 1)))))) // INLINED!!
endfunction
...
function s__Args_imageSet takes integer i,image value returns nothing
    call s__Args_setHandle((98) , (i ) , ( value)) // INLINED!!
endfunction
...
function s__Args_imageFree takes integer i returns nothing
    call s__Args_freeHandle((98) , (i)) // INLINED!!
endfunction

// Advanced methods
function s__Args_imageGetDepth takes integer i returns integer
    return (LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((98)))), (i)))), (- 1))) + 1 // INLINED!!
endfunction

function s__Args_imageDig takes integer i,integer depth returns image
    return (LoadImageHandle(Table___ht, ((((LoadInteger(ConstTable___ht, ((((98)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((98)))), (i)))), (- 1))) - depth))) // INLINED!!
endfunction

function s__Args_imageDestroyStack takes integer whichStack returns nothing
    call s__Table_destroy((LoadInteger(ConstTable___ht, ((((98)))), (whichStack)))) // INLINED!!
endfunction
...
function s__Args_getUbersplat takes integer i returns ubersplat
    return (LoadUbersplatHandle(Table___ht, ((((LoadInteger(ConstTable___ht, ((((100)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((100)))), (i)))), (- 1)))))) // INLINED!!
endfunction
...
function s__Args_ubersplatSet takes integer i,ubersplat value returns nothing
    call s__Args_setHandle((100) , (i ) , ( value)) // INLINED!!
endfunction
...
function s__Args_ubersplatFree takes integer i returns nothing
    call s__Args_freeHandle((100) , (i)) // INLINED!!
endfunction

// Advanced methods
function s__Args_ubersplatGetDepth takes integer i returns integer
    return (LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((100)))), (i)))), (- 1))) + 1 // INLINED!!
endfunction

function s__Args_ubersplatDig takes integer i,integer depth returns ubersplat
    return (LoadUbersplatHandle(Table___ht, ((((LoadInteger(ConstTable___ht, ((((100)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((100)))), (i)))), (- 1))) - depth))) // INLINED!!
endfunction

function s__Args_ubersplatDestroyStack takes integer whichStack returns nothing
    call s__Table_destroy((LoadInteger(ConstTable___ht, ((((100)))), (whichStack)))) // INLINED!!
endfunction
...
function s__Args_getFogstate takes integer i returns fogstate
    return (LoadFogStateHandle(Table___ht, ((((LoadInteger(ConstTable___ht, ((((102)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((102)))), (i)))), (- 1)))))) // INLINED!!
endfunction
...
function s__Args_fogstateSet takes integer i,fogstate value returns nothing
    call s__Args_setHandle((102) , (i ) , ( value)) // INLINED!!
endfunction
...
function s__Args_fogstateFree takes integer i returns nothing
    call s__Args_freeHandle((102) , (i)) // INLINED!!
endfunction

// Advanced methods
function s__Args_fogstateGetDepth takes integer i returns integer
    return (LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((102)))), (i)))), (- 1))) + 1 // INLINED!!
endfunction

function s__Args_fogstateDig takes integer i,integer depth returns fogstate
    return (LoadFogStateHandle(Table___ht, ((((LoadInteger(ConstTable___ht, ((((102)))), (i)))))), ((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, ((((102)))), (i)))), (- 1))) - depth))) // INLINED!!
endfunction

function s__Args_fogstateDestroyStack takes integer whichStack returns nothing
    call s__Table_destroy((LoadInteger(ConstTable___ht, ((((102)))), (whichStack)))) // INLINED!!
endfunction
...
//Implemented from module GLHS___Iter:
    ...
    function s__LinkedHashSet_create takes nothing returns integer
        return GMUI_GetIndex(((10))) // INLINED!!
    endfunction
...
//textmacro instance: GMUI_RecycleIndex("this","thistype.RECYCLE_KEY()")
    call SaveInteger(GMUI_hashTable, ((10)), this, LoadInteger(GMUI_hashTable, ((10)), 0)) // INLINED!!
    call SaveInteger(GMUI_hashTable, ((10)), 0, this) // INLINED!!
...
//textmacro instance: ConstTable_NewReadonlyStructField("items", "Table")
    function s__MultiBoard__get_items takes integer this returns integer
        return (LoadInteger(ConstTable___ht, (((104))), (this))) // INLINED!!
    endfunction
    
    function s__MultiBoard__set_items takes integer this,integer new_items returns nothing
        call SaveInteger(ConstTable___ht, (((104))), (this), ( new_items)) // INLINED!!
    endfunction
    
    function s__MultiBoard_itemsClear takes integer this returns nothing
        call RemoveSavedInteger(ConstTable___ht, (((104))), (this)) // INLINED!!
    endfunction
...
//textmacro instance: ConstTable_NewReadonlyPrimitiveField("cols", "integer")
    function s__MultiBoard__get_cols takes integer this returns integer
        return (LoadInteger(ConstTable___ht, (((((106))))), (this))) // INLINED!!
    endfunction
    
    function s__MultiBoard__set_cols takes integer this,integer new_cols returns nothing
        call SaveInteger(ConstTable___ht, (((((106))))), (this), ( new_cols)) // INLINED!!
    endfunction
    
    function s__MultiBoard_colsClear takes integer this returns nothing
        call RemoveSavedInteger(ConstTable___ht, (((((106))))), (this)) // INLINED!!
    endfunction
...
//textmacro instance: ConstTable_NewReadonlyPrimitiveField("rows", "integer")
    function s__MultiBoard__get_rows takes integer this returns integer
        return (LoadInteger(ConstTable___ht, (((((108))))), (this))) // INLINED!!
    endfunction
    
    function s__MultiBoard__set_rows takes integer this,integer new_rows returns nothing
        call SaveInteger(ConstTable___ht, (((((108))))), (this), ( new_rows)) // INLINED!!
    endfunction
    
    function s__MultiBoard_rowsClear takes integer this returns nothing
        call RemoveSavedInteger(ConstTable___ht, (((((108))))), (this)) // INLINED!!
    endfunction
//end of: ConstTable_NewReadonlyPrimitiveField("rows", "integer")
    ...
    function s__MultiBoard_get takes integer this,integer i,integer j returns multiboarditem
        return (LoadMultiboardItemHandle(Table___ht, ((((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, (((104))), ((this))))), (i)))))), (j))) // INLINED!!
    endfunction
    ...
    function s__MultiBoard_refresh takes multiboard mb returns integer
        ...
        local integer oldCols= (LoadInteger(ConstTable___ht, (((((106))))), ((this)))) // INLINED!!
        local integer oldRows= (LoadInteger(ConstTable___ht, (((((108))))), ((this)))) // INLINED!!
        
        local integer i= 0
        local integer j
        
        if (LoadInteger(ConstTable___ht, (((104))), ((this)))) == 0 then // INLINED!!
            call SaveInteger(ConstTable___ht, (((104))), ((this)), ( (s__Table_create()))) // INLINED!!
            call BJDebugMsg("Created items table. (" + I2S((LoadInteger(ConstTable___ht, (((104))), ((this))))) + ")") // INLINED!!
        endif

        loop
        exitwhen i >= rows
            if i >= oldRows then
                call SaveInteger(Table___ht, ((LoadInteger(ConstTable___ht, (((104))), ((this))))), (i), ( s__Table_create())) // INLINED!!
                call BJDebugMsg("Created row: " + I2S(i) + " (" + I2S((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, (((104))), ((this))))), (i)))) + ")") // INLINED!!
                set j=0
            else
                set j=cols
                loop
                exitwhen j >= oldCols
                    ...
                    call MultiboardReleaseItem((LoadMultiboardItemHandle(Table___ht, ((((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, (((104))), ((this))))), (i)))))), (j)))) // INLINED!!
                    call RemoveSavedHandle(Table___ht, ((((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, (((104))), ((this))))), (i)))))), (j)) // INLINED!!
                    set j=j + 1
                endloop
                set j=oldCols
            endif
            call SaveInteger(Table___ht, ((LoadInteger(ConstTable___ht, (((104))), ((this))))), (0), ( s__Table_create())) // INLINED!!
            loop
            exitwhen j >= cols
                call SaveMultiboardItemHandle(Table___ht, ((((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, (((104))), ((this))))), (i)))))), (j), ( MultiboardGetItem(mb, i, j))) // INLINED!!
                call BJDebugMsg("Creating item: " + I2S(j) + " (" + I2S(GetHandleId((LoadMultiboardItemHandle(Table___ht, ((((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, (((104))), (((this)))))), ((i ))))))), (( j)))))) + ")") // INLINED!!
                set j=j + 1
            endloop
            set i=i + 1
        endloop
        ...
        exitwhen i >= oldCols
            ...
            loop
                ...
                set j=j + 1
            endloop
            call s__Table_destroy((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, (((104))), ((this))))), (i)))) // INLINED!!
            set i=i + 1
        endloop
        
        call SaveInteger(ConstTable___ht, (((((106))))), ((this)), ( (cols))) // INLINED!!
        call SaveInteger(ConstTable___ht, (((((108))))), ((this)), ( (rows))) // INLINED!!
...
//textmacro instance: ConstTable_NewReadonlyStaticPrimitiveField("hours", "integer")
    function s__GameTime__get_hours takes nothing returns integer
        return (LoadInteger(ConstTable___ht, (((((110))))), ((112)))) // INLINED!!
    endfunction
    
    function s__GameTime__set_hours takes integer new_hours returns nothing
        call SaveInteger(ConstTable___ht, (((((110))))), ((112)), ( new_hours)) // INLINED!!
    endfunction
    
    function s__GameTime_hoursClear takes nothing returns nothing
        call RemoveSavedInteger(ConstTable___ht, (((((110))))), ((112))) // INLINED!!
    endfunction
    
    function s__GameTime_hoursExists takes nothing returns boolean
        return (HaveSavedInteger(ConstTable___ht, (((((110))))), ((112)))) // INLINED!!
    endfunction
...
//textmacro instance: ConstTable_NewReadonlyStaticPrimitiveField("minutes", "integer")
    function s__GameTime__get_minutes takes nothing returns integer
        return (LoadInteger(ConstTable___ht, (((((110))))), ((114)))) // INLINED!!
    endfunction
    
    function s__GameTime__set_minutes takes integer new_minutes returns nothing
        call SaveInteger(ConstTable___ht, (((((110))))), ((114)), ( new_minutes)) // INLINED!!
    endfunction
    
    function s__GameTime_minutesClear takes nothing returns nothing
        call RemoveSavedInteger(ConstTable___ht, (((((110))))), ((114))) // INLINED!!
    endfunction
    
    function s__GameTime_minutesExists takes nothing returns boolean
        return (HaveSavedInteger(ConstTable___ht, (((((110))))), ((114)))) // INLINED!!
    endfunction
...
//textmacro instance: ConstTable_NewReadonlyStaticPrimitiveField("seconds", "integer")
    function s__GameTime__get_seconds takes nothing returns integer
        return (LoadInteger(ConstTable___ht, (((((110))))), ((116)))) // INLINED!!
    endfunction
    
    function s__GameTime__set_seconds takes integer new_seconds returns nothing
        call SaveInteger(ConstTable___ht, (((((110))))), ((116)), ( new_seconds)) // INLINED!!
    endfunction
    
    function s__GameTime_secondsClear takes nothing returns nothing
        call RemoveSavedInteger(ConstTable___ht, (((((110))))), ((116))) // INLINED!!
    endfunction
    
    function s__GameTime_secondsExists takes nothing returns boolean
        return (HaveSavedInteger(ConstTable___ht, (((((110))))), ((116)))) // INLINED!!
    endfunction
...
//textmacro instance: ConstTable_NewReadonlyStaticHandleField("timer", "timer")
    function s__GameTime__get_timer takes nothing returns timer
        return (LoadTimerHandle(ConstTable___ht, (((((110))))), ((118)))) // INLINED!!
    endfunction
    ...
    function s__GameTime_timerClear takes nothing returns nothing
        call RemoveSavedHandle(ConstTable___ht, (((((110))))), ((118))) // INLINED!!
    endfunction
    
    function s__GameTime_timerExists takes nothing returns boolean
        return (HaveSavedHandle(ConstTable___ht, (((((110))))), ((118)))) // INLINED!!
    endfunction
...
//textmacro instance: ConstTable_NewReadonlyStaticHandleField("multiboard", "multiboard")
    function s__GameTime__get_multiboard takes nothing returns multiboard
        return (LoadMultiboardHandle(ConstTable___ht, (((((110))))), ((120)))) // INLINED!!
    endfunction
    ...
    function s__GameTime_multiboardClear takes nothing returns nothing
        call RemoveSavedHandle(ConstTable___ht, (((((110))))), ((120))) // INLINED!!
    endfunction
    
    function s__GameTime_multiboardExists takes nothing returns boolean
        return (HaveSavedHandle(ConstTable___ht, (((((110))))), ((120)))) // INLINED!!
    endfunction
//end of: ConstTable_NewReadonlyStaticHandleField("multiboard", "multiboard")
    ...
    function s__GameTime_toString takes nothing returns string
        return I2S((LoadInteger(ConstTable___ht, (((((110))))), ((112))))) + " : " + I2S((LoadInteger(ConstTable___ht, (((((110))))), ((114))))) + " : " + I2S((LoadInteger(ConstTable___ht, (((((110))))), ((116))))) // INLINED!!
    endfunction
    
    function s__GameTime_toStringEx takes string sep returns string
        return I2S((LoadInteger(ConstTable___ht, (((((110))))), ((112))))) + sep + I2S((LoadInteger(ConstTable___ht, (((((110))))), ((114))))) + sep + I2S((LoadInteger(ConstTable___ht, (((((110))))), ((116))))) // INLINED!!
    endfunction
    
    function s__GameTime_asMinutes takes nothing returns real
        return 60. * (LoadInteger(ConstTable___ht, (((((110))))), ((112)))) + (LoadInteger(ConstTable___ht, (((((110))))), ((114)))) + (LoadInteger(ConstTable___ht, (((((110))))), ((116)))) / 60. // INLINED!!
    endfunction
    
    function s__GameTime_asHours takes nothing returns real
        return (LoadInteger(ConstTable___ht, (((((110))))), ((112)))) + (LoadInteger(ConstTable___ht, (((((110))))), ((114)))) / 60. + (LoadInteger(ConstTable___ht, (((((110))))), ((116)))) / 3600. // INLINED!!
    endfunction
    
    function s__GameTime_asSeconds takes nothing returns integer
        return (LoadInteger(ConstTable___ht, (((((110))))), ((112)))) * 3600 + (LoadInteger(ConstTable___ht, (((((110))))), ((114)))) * 60 + (LoadInteger(ConstTable___ht, (((((110))))), ((116)))) // INLINED!!
    endfunction
    
    function s__GameTime_onTimer takes nothing returns nothing
        local integer sec= (LoadInteger(ConstTable___ht, (((((110))))), ((116)))) // INLINED!!
        local string s
    
        if sec == 0 and (LoadInteger(ConstTable___ht, (((((110))))), ((114)))) == 0 and (LoadInteger(ConstTable___ht, (((((110))))), ((112)))) == 0 then // INLINED!!
            call ConstTable_SetHandle((110) , (120) , (CreateMultiboard())) // INLINED!!
            call MultiboardSetRowCount((LoadMultiboardHandle(ConstTable___ht, (((((110))))), ((120)))), 1) // INLINED!!
            call MultiboardSetColumnCount((LoadMultiboardHandle(ConstTable___ht, (((((110))))), ((120)))), 5) // INLINED!!
            call MultiboardSetTitleText((LoadMultiboardHandle(ConstTable___ht, (((((110))))), ((120)))), "Elapsed Time") // INLINED!!
            
            set sec=s__MultiBoard_refresh((LoadMultiboardHandle(ConstTable___ht, (((((110))))), ((120))))) // INLINED!!
            call MultiboardSetItemStyle((LoadMultiboardItemHandle(Table___ht, ((((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, (((104))), (((sec)))))), ((0 ))))))), (( 0)))), true, false) // INLINED!!
            call MultiboardSetItemStyle((LoadMultiboardItemHandle(Table___ht, ((((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, (((104))), (((sec)))))), ((0 ))))))), (( 1)))), true, false) // INLINED!!
            call MultiboardSetItemStyle((LoadMultiboardItemHandle(Table___ht, ((((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, (((104))), (((sec)))))), ((0 ))))))), (( 2)))), true, false) // INLINED!!
            call MultiboardSetItemStyle((LoadMultiboardItemHandle(Table___ht, ((((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, (((104))), (((sec)))))), ((0 ))))))), (( 3)))), true, false) // INLINED!!
            call MultiboardSetItemStyle((LoadMultiboardItemHandle(Table___ht, ((((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, (((104))), (((sec)))))), ((0 ))))))), (( 4)))), true, false) // INLINED!!
            call MultiboardSetItemWidth((LoadMultiboardItemHandle(Table___ht, ((((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, (((104))), (((sec)))))), ((0 ))))))), (( 0)))), 0.015) // INLINED!!
            call MultiboardSetItemWidth((LoadMultiboardItemHandle(Table___ht, ((((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, (((104))), (((sec)))))), ((0 ))))))), (( 1)))), 0.005) // INLINED!!
            call MultiboardSetItemWidth((LoadMultiboardItemHandle(Table___ht, ((((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, (((104))), (((sec)))))), ((0 ))))))), (( 2)))), 0.015) // INLINED!!
            call MultiboardSetItemWidth((LoadMultiboardItemHandle(Table___ht, ((((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, (((104))), (((sec)))))), ((0 ))))))), (( 3)))), 0.005) // INLINED!!
            call MultiboardSetItemWidth((LoadMultiboardItemHandle(Table___ht, ((((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, (((104))), (((sec)))))), ((0 ))))))), (( 4)))), 0.015) // INLINED!!
            set sec=0
        endif
    
        if sec == 60 then
            if (LoadInteger(ConstTable___ht, (((((110))))), ((114)))) == 60 then // INLINED!!
                call SaveInteger(ConstTable___ht, (((((110))))), ((112)), ( ((LoadInteger(ConstTable___ht, (((((110))))), ((112)))) + 1))) // INLINED!!
                call SaveInteger(ConstTable___ht, (((((110))))), ((114)), ( (0))) // INLINED!!
            else
                call SaveInteger(ConstTable___ht, (((((110))))), ((114)), ( ((LoadInteger(ConstTable___ht, (((((110))))), ((114)))) + 1))) // INLINED!!
            endif
            call SaveInteger(ConstTable___ht, (((((110))))), ((116)), ( (0))) // INLINED!!
        else
            call SaveInteger(ConstTable___ht, (((((110))))), ((116)), ( (sec + 1))) // INLINED!!
        endif
        
        set sec=GetHandleId((LoadMultiboardHandle(ConstTable___ht, (((((110))))), ((120))))) // INLINED!!
        //call MultiboardSuppressDisplay(false)
        
        set s=I2S((LoadInteger(ConstTable___ht, (((((110))))), ((112))))) // INLINED!!
        if StringLength(s) == 1 then
            set s="0" + s
        endif
        call MultiboardSetItemValue((LoadMultiboardItemHandle(Table___ht, ((((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, (((104))), (((sec)))))), ((0 ))))))), (( 0)))), s) // INLINED!!
        call MultiboardSetItemValue((LoadMultiboardItemHandle(Table___ht, ((((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, (((104))), (((sec)))))), ((0 ))))))), (( 1)))), ":") // INLINED!!
        set s=I2S((LoadInteger(ConstTable___ht, (((((110))))), ((114))))) // INLINED!!
        if StringLength(s) == 1 then
            set s="0" + s
        endif
        call MultiboardSetItemValue((LoadMultiboardItemHandle(Table___ht, ((((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, (((104))), (((sec)))))), ((0 ))))))), (( 2)))), s) // INLINED!!
        call MultiboardSetItemValue((LoadMultiboardItemHandle(Table___ht, ((((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, (((104))), (((sec)))))), ((0 ))))))), (( 3)))), ":") // INLINED!!
        set s=I2S((LoadInteger(ConstTable___ht, (((((110))))), ((116))))) // INLINED!!
        if StringLength(s) == 1 then
            set s="0" + s
        endif
        call MultiboardSetItemValue((LoadMultiboardItemHandle(Table___ht, ((((LoadInteger(Table___ht, ((LoadInteger(ConstTable___ht, (((104))), (((sec)))))), ((0 ))))))), (( 4)))), s) // INLINED!!
        
        call MultiboardDisplay((LoadMultiboardHandle(ConstTable___ht, (((((110))))), ((120)))), true) // INLINED!!
    endfunction
    
    function s__GameTime_onInit takes nothing returns nothing
        call ConstTable_SetHandle((110) , (118) , (CreateTimer())) // INLINED!!
                
        
        call TimerStart((LoadTimerHandle(ConstTable___ht, (((((110))))), ((118)))), 1., true, function s__GameTime_onTimer) // INLINED!!
    endfunction
...
//textmacro instance: ConstTable_NewPrimitiveField("style", "integer")
    function s__TerrainFog__get_style takes integer this returns integer
        return (LoadInteger(ConstTable___ht, (((((122))))), (this))) // INLINED!!
    endfunction
    
    function s__TerrainFog__set_style takes integer this,integer new_style returns nothing
        call SaveInteger(ConstTable___ht, (((((122))))), (this), ( new_style)) // INLINED!!
    endfunction
    
    function s__TerrainFog_styleClear takes integer this returns nothing
        call RemoveSavedInteger(ConstTable___ht, (((((122))))), (this)) // INLINED!!
    endfunction
...
//textmacro instance: ConstTable_NewPrimitiveField("zStart", "real")
    function s__TerrainFog__get_zStart takes integer this returns real
        return (LoadReal(ConstTable___ht, (((((124))))), (this))) // INLINED!!
    endfunction
    
    function s__TerrainFog__set_zStart takes integer this,real new_zStart returns nothing
        call SaveReal(ConstTable___ht, (((((124))))), (this), (( new_zStart)*1.0)) // INLINED!!
    endfunction
    
    function s__TerrainFog_zStartClear takes integer this returns nothing
        call RemoveSavedReal(ConstTable___ht, (((((124))))), (this)) // INLINED!!
    endfunction
...
//textmacro instance: ConstTable_NewPrimitiveField("zEnd", "real")
    function s__TerrainFog__get_zEnd takes integer this returns real
        return (LoadReal(ConstTable___ht, (((((126))))), (this))) // INLINED!!
    endfunction
    
    function s__TerrainFog__set_zEnd takes integer this,real new_zEnd returns nothing
        call SaveReal(ConstTable___ht, (((((126))))), (this), (( new_zEnd)*1.0)) // INLINED!!
    endfunction
    
    function s__TerrainFog_zEndClear takes integer this returns nothing
        call RemoveSavedReal(ConstTable___ht, (((((126))))), (this)) // INLINED!!
    endfunction
...
//textmacro instance: ConstTable_NewPrimitiveField("density", "real")
    function s__TerrainFog__get_density takes integer this returns real
        return (LoadReal(ConstTable___ht, (((((128))))), (this))) // INLINED!!
    endfunction
    
    function s__TerrainFog__set_density takes integer this,real new_density returns nothing
        call SaveReal(ConstTable___ht, (((((128))))), (this), (( new_density)*1.0)) // INLINED!!
    endfunction
    
    function s__TerrainFog_densityClear takes integer this returns nothing
        call RemoveSavedReal(ConstTable___ht, (((((128))))), (this)) // INLINED!!
    endfunction
...
//textmacro instance: ConstTable_NewPrimitiveField("red", "real")
    function s__TerrainFog__get_red takes integer this returns real
        return (LoadReal(ConstTable___ht, (((((130))))), (this))) // INLINED!!
    endfunction
    
    function s__TerrainFog__set_red takes integer this,real new_red returns nothing
        call SaveReal(ConstTable___ht, (((((130))))), (this), (( new_red)*1.0)) // INLINED!!
    endfunction
    
    function s__TerrainFog_redClear takes integer this returns nothing
        call RemoveSavedReal(ConstTable___ht, (((((130))))), (this)) // INLINED!!
    endfunction
...
//textmacro instance: ConstTable_NewPrimitiveField("green", "real")
    function s__TerrainFog__get_green takes integer this returns real
        return (LoadReal(ConstTable___ht, (((((132))))), (this))) // INLINED!!
    endfunction
    
    function s__TerrainFog__set_green takes integer this,real new_green returns nothing
        call SaveReal(ConstTable___ht, (((((132))))), (this), (( new_green)*1.0)) // INLINED!!
    endfunction
    
    function s__TerrainFog_greenClear takes integer this returns nothing
        call RemoveSavedReal(ConstTable___ht, (((((132))))), (this)) // INLINED!!
    endfunction
...
//textmacro instance: ConstTable_NewPrimitiveField("blue", "real")
    function s__TerrainFog__get_blue takes integer this returns real
        return (LoadReal(ConstTable___ht, (((((134))))), (this))) // INLINED!!
    endfunction
    
    function s__TerrainFog__set_blue takes integer this,real new_blue returns nothing
        call SaveReal(ConstTable___ht, (((((134))))), (this), (( new_blue)*1.0)) // INLINED!!
    endfunction
    
    function s__TerrainFog_blueClear takes integer this returns nothing
        call RemoveSavedReal(ConstTable___ht, (((((134))))), (this)) // INLINED!!
    endfunction
//end of: ConstTable_NewPrimitiveField("blue", "real")
    ...
    function s__TerrainFog_applyForPlayer takes integer this,player whichPlayer returns nothing
        if GetLocalPlayer() == whichPlayer then
            call SetTerrainFogEx((LoadInteger(ConstTable___ht, (((((122))))), ((this)))), (LoadReal(ConstTable___ht, (((((124))))), ((this)))), (LoadReal(ConstTable___ht, (((((126))))), ((this)))), (LoadReal(ConstTable___ht, (((((128))))), ((this)))), (LoadReal(ConstTable___ht, (((((130))))), ((this)))), (LoadReal(ConstTable___ht, (((((132))))), ((this)))), (LoadReal(ConstTable___ht, (((((134))))), ((this))))) // INLINED!!
        endif
    endfunction
...
//textmacro instance: ConstTable_NewStructField("fog", "TerrainFog")
    function s__RectEnvironment__get_fog takes integer this returns integer
        return (LoadInteger(ConstTable___ht, (((136))), (this))) // INLINED!!
    endfunction
    
    function s__RectEnvironment__set_fog takes integer this,integer new_fog returns nothing
        call SaveInteger(ConstTable___ht, (((136))), (this), ( new_fog)) // INLINED!!
    endfunction
    
    function s__RectEnvironment_fogClear takes integer this returns nothing
        call RemoveSavedInteger(ConstTable___ht, (((136))), (this)) // INLINED!!
    endfunction
//end of: ConstTable_NewStructField("fog", "TerrainFog")
    
    function s__RectEnvironment_apply takes integer this returns nothing
        local integer fog= (LoadInteger(ConstTable___ht, (((136))), ((this)))) // INLINED!!
        if (LoadInteger(ConstTable___ht, (((136))), ((this)))) != 0 then // INLINED!!
            call s__TerrainFog_apply((LoadInteger(ConstTable___ht, (((136))), ((this))))) // INLINED!!
        else
...
//textmacro instance: ConstTable_NewStaticHandleField("lastCameraRect", "rect")
    function s__AutoRectEnvironment___Globals__get_lastCameraRect takes nothing returns rect
        return (LoadRectHandle(ConstTable___ht, (((((138))))), ((146)))) // INLINED!!
    endfunction
    ...
    function s__AutoRectEnvironment___Globals_lastCameraRectClear takes nothing returns nothing
        call RemoveSavedHandle(ConstTable___ht, (((((138))))), ((146))) // INLINED!!
    endfunction
...
//textmacro instance: ConstTable_NewStaticHandleField("allRects", "region")
    function s__AutoRectEnvironment___Globals__get_allRects takes nothing returns region
        return (LoadRegionHandle(ConstTable___ht, (((((138))))), ((148)))) // INLINED!!
    endfunction
    ...
    function s__AutoRectEnvironment___Globals_allRectsClear takes nothing returns nothing
        call RemoveSavedHandle(ConstTable___ht, (((((138))))), ((148))) // INLINED!!
    endfunction
...
function AutoRectEnvironment_RegisterRect takes rect r returns nothing
    ...
    if not (HaveSavedHandle(ConstTable___ht, (((((152))))), (rId))) then // INLINED!!
        call SaveRectHandle(ConstTable___ht, (((((152))))), (rId), ( r)) // INLINED!!
        call RegionAddRect((LoadRegionHandle(ConstTable___ht, (((((138))))), ((148)))), r) // INLINED!!
        call GLHS___AddBefore((((LoadInteger(ConstTable___ht, (((138))), ((150)))))) , (0 ) , ( (rId))) // INLINED!!
    endif
endfunction
...
function AutoRectEnvironment_DeRegisterRect takes rect r returns nothing
    ...
    if r == (LoadRectHandle(ConstTable___ht, (((((138))))), ((146)))) then // INLINED!!
        call ConstTable_SetHandle((138) , (146) , (null)) // This possibly avoids desyncs. // INLINED!!
    endif
    
    if (HaveSavedHandle(ConstTable___ht, (((((152))))), (rId))) then // INLINED!!
        call SaveBoolean(ConstTable___ht, (((((138))))), ((144)), ( (true))) // INLINED!!
        call RemoveSavedHandle(ConstTable___ht, (((((152))))), (rId)) // INLINED!!
        call RegionClearRect((LoadRegionHandle(ConstTable___ht, (((((138))))), ((148)))), r) // INLINED!!
        call s__LinkedHashSet_delete(((LoadInteger(ConstTable___ht, (((138))), ((150))))),(rId)) // INLINED!!
    endif
endfunction

function AutoRectEnvironment_MoveRect takes rect r,real newCenterX,real newCenterY returns nothing

    if (HaveSavedHandle(ConstTable___ht, (((((152))))), (GetHandleId(r)))) then // INLINED!!
        call SaveBoolean(ConstTable___ht, (((((138))))), ((144)), ( (true))) // INLINED!!
        call RegionClearRect((LoadRegionHandle(ConstTable___ht, (((((138))))), ((148)))), r) // INLINED!!
...
function onTimer takes nothing returns nothing
    ...
    if (LoadRectHandle(ConstTable___ht, (((((138))))), ((146)))) != null then // INLINED!!
        if GetRectMinX((LoadRectHandle(ConstTable___ht, (((((138))))), ((146))))) <= x and x <= GetRectMaxX((LoadRectHandle(ConstTable___ht, (((((138))))), ((146))))) and GetRectMinY((LoadRectHandle(ConstTable___ht, (((((138))))), ((146))))) <= y and y <= GetRectMaxY((LoadRectHandle(ConstTable___ht, (((((138))))), ((146))))) then // INLINED!!
            //call BJDebugMsg("In last rect.")
            call s__RectEnvironment_apply((GetHandleId(((LoadRectHandle(ConstTable___ht, (((((138))))), ((146)))))))) // INLINED!!
            return
        else
    ...
    if (LoadBoolean(ConstTable___ht, (((((138))))), ((144)))) then // INLINED!!
        call SaveBoolean(ConstTable___ht, (((((138))))), ((144)), ( (false))) // INLINED!!
    else
        if (LoadReal(ConstTable___ht, (((((138))))), ((140)))) == x and (LoadReal(ConstTable___ht, (((((138))))), ((142)))) == y then // INLINED!!
            //call BJDebugMsg("Camera did not move, no Globals.rects moved: do nothing.")
            return
        endif
    endif
    
    if IsPointInRegion((LoadRegionHandle(ConstTable___ht, (((((138))))), ((148)))), x, y) then // INLINED!!
        set i=(LoadInteger((Lists___hashTable), (((LoadInteger(ConstTable___ht, (((138))), ((150))))) ), ( 0))) // INLINED!!
            loop
                exitwhen i == (0) // INLINED!!
                set r=(LoadRectHandle(ConstTable___ht, (((((152))))), (i))) // INLINED!!
                
                if GetRectMinX(r) <= x and x <= GetRectMaxX(r) and GetRectMinY(r) <= y and y <= GetRectMaxY(r) then
                    //call BJDebugMsg("Found rect!")
                    call ConstTable_SetHandle((138) , (146) , (r)) // INLINED!!
                    call s__RectEnvironment_apply((GetHandleId((r)))) // INLINED!!
                    exitwhen true
                endif
            
                set i=(LoadInteger((Lists___hashTable), (((LoadInteger(ConstTable___ht, (((138))), ((150))))) ), ( (i)))) // INLINED!!
            endloop
        set r=null
    else
    ...
    call SaveReal(ConstTable___ht, (((((138))))), ((140)), (( ((x)*1.0))*1.0)) // INLINED!!
    call SaveReal(ConstTable___ht, (((((138))))), ((142)), (( ((y)*1.0))*1.0)) // INLINED!!
endfunction
...
//Implemented from module AutoRectEnvironment___InitModule:
    function s__AutoRectEnvironment___InitStruct_AutoRectEnvironment___InitModule__onInit takes nothing returns nothing
        ...
        call SaveInteger(ConstTable___ht, (((138))), ((150)), ( ((GMUI_GetIndex(((10))))))) // INLINED!!
        
        call ConstTable_SetHandle((138) , (148) , (CreateRegion())) // INLINED!!
...
function CreateGUDR takes unit centerUnit returns boolean
    ...
    set userDefRect=Rect(centerX - 32, centerY - 32, centerX + 32, centerY + 32)
        ...
        set fog=(GMUI_GetIndex(((0)))) // INLINED!!
        call SaveInteger(ConstTable___ht, (((136))), (((GetHandleId((userDefRect))))), ( (fog))) // INLINED!!
        call SaveInteger(ConstTable___ht, (((((122))))), ((fog)), ( ((1)))) // INLINED!!
...
function DestroyGUDR takes unit centerUnit returns nothing
    ...
    local rect udr= LoadRectHandle(UserDefinedRects__hashTable, unitId, 0)
        ...
        local integer fog= (LoadInteger(ConstTable___ht, (((136))), (((GetHandleId((udr))))))) // INLINED!!
...
function UserDefinedRects__onInit takes nothing returns nothing
    ...
    set UserDefinedRects__hashTable=GetLastCreatedHashtableBJ()
        ...
        call SaveInteger(GMUI_hashTable, ((12)), 0, 1) // INLINED!!
...
function UserDefinedRectsGeneratorAddon__Conditions takes unit whichUnit returns boolean
    return GetUnitTypeId(whichUnit) == ('udr0') // LoP_IsUnitDecoration(whichUnit)
endfunction
...
function UserDefinedRectsGeneratorAddon__onCast takes nothing returns boolean
    ...
    if not (GetUnitTypeId((GetTriggerUnit())) == ('udr0')) then // INLINED!!
        
    elseif abilityId == ('UDRQ') then
        if (GetUnitAbilityLevel((GetTriggerUnit()), ('UDR2')) > 0) then // INLINED!!
...
//end of: GUDR_SecondPage("Add","GetTriggerUnit()")
        elseif (GetUnitAbilityLevel((GetTriggerUnit()), ('UDR9')) > 0) then // INLINED!!
...
//end of: GUDR_SecondPage("Add","GetTriggerUnit()")
    ...
    elseif abilityId == ('UDRC') then
        if (LoadReal(ConstTable___ht, (((((130))))), (((LoadInteger(ConstTable___ht, (((136))), (((GetHandleId(((LoadRectHandle(UserDefinedRects__hashTable, (GetHandleId((GetTriggerUnit()))), (0)))))))))))))) <= .96 then // INLINED!!
            call SaveReal(ConstTable___ht, (((((130))))), (((LoadInteger(ConstTable___ht, (((136))), (((GetHandleId(((LoadRectHandle(UserDefinedRects__hashTable, (GetHandleId((GetTriggerUnit()))), (0)))))))))))), (( (((LoadReal(ConstTable___ht, (((((130))))), (((LoadInteger(ConstTable___ht, (((136))), (((GetHandleId(((LoadRectHandle(UserDefinedRects__hashTable, (GetHandleId((GetTriggerUnit()))), (0)))))))))))))) + .05)*1.0))*1.0)) // INLINED!!
        else
            call SaveReal(ConstTable___ht, (((((130))))), (((LoadInteger(ConstTable___ht, (((136))), (((GetHandleId(((LoadRectHandle(UserDefinedRects__hashTable, (GetHandleId((GetTriggerUnit()))), (0)))))))))))), (( ((0.)*1.0))*1.0)) // INLINED!!
        endif
        call DisplayTextToPlayer(GetOwningPlayer(GetTriggerUnit()), 0, 0, ("Fog " + ("|c00ff0000Red|r" ) + " set to: " + I2S(R2I((( (LoadReal(ConstTable___ht, (((((130))))), (((LoadInteger(ConstTable___ht, (((136))), (((GetHandleId(((LoadRectHandle(UserDefinedRects__hashTable, (GetHandleId((GetTriggerUnit()))), (0)))))))))))))))*1.0) * 100. + .5)) + "%")) // INLINED!!
    
    elseif abilityId == ('UDRD') then
        if (LoadReal(ConstTable___ht, (((((130))))), (((LoadInteger(ConstTable___ht, (((136))), (((GetHandleId(((LoadRectHandle(UserDefinedRects__hashTable, (GetHandleId((GetTriggerUnit()))), (0)))))))))))))) >= 0.01 then // INLINED!!
            call SaveReal(ConstTable___ht, (((((130))))), (((LoadInteger(ConstTable___ht, (((136))), (((GetHandleId(((LoadRectHandle(UserDefinedRects__hashTable, (GetHandleId((GetTriggerUnit()))), (0)))))))))))), (( (((LoadReal(ConstTable___ht, (((((130))))), (((LoadInteger(ConstTable___ht, (((136))), (((GetHandleId(((LoadRectHandle(UserDefinedRects__hashTable, (GetHandleId((GetTriggerUnit()))), (0)))))))))))))) - .05)*1.0))*1.0)) // INLINED!!
        else
            call SaveReal(ConstTable___ht, (((((130))))), (((LoadInteger(ConstTable___ht, (((136))), (((GetHandleId(((LoadRectHandle(UserDefinedRects__hashTable, (GetHandleId((GetTriggerUnit()))), (0)))))))))))), (( ((1.)*1.0))*1.0)) // INLINED!!
        endif
        call DisplayTextToPlayer(GetOwningPlayer(GetTriggerUnit()), 0, 0, ("Fog " + ("|c00ff0000Red|r" ) + " set to: " + I2S(R2I((( (LoadReal(ConstTable___ht, (((((130))))), (((LoadInteger(ConstTable___ht, (((136))), (((GetHandleId(((LoadRectHandle(UserDefinedRects__hashTable, (GetHandleId((GetTriggerUnit()))), (0)))))))))))))))*1.0) * 100. + .5)) + "%")) // INLINED!!
        
    elseif abilityId == ('UDRE') then
        if (LoadReal(ConstTable___ht, (((((134))))), (((LoadInteger(ConstTable___ht, (((136))), (((GetHandleId(((LoadRectHandle(UserDefinedRects__hashTable, (GetHandleId((GetTriggerUnit()))), (0)))))))))))))) <= .96 then // INLINED!!
            call SaveReal(ConstTable___ht, (((((134))))), (((LoadInteger(ConstTable___ht, (((136))), (((GetHandleId(((LoadRectHandle(UserDefinedRects__hashTable, (GetHandleId((GetTriggerUnit()))), (0)))))))))))), (( (((LoadReal(ConstTable___ht, (((((134))))), (((LoadInteger(ConstTable___ht, (((136))), (((GetHandleId(((LoadRectHandle(UserDefinedRects__hashTable, (GetHandleId((GetTriggerUnit()))), (0)))))))))))))) + .05)*1.0))*1.0)) // INLINED!!
        else
            call SaveReal(ConstTable___ht, (((((134))))), (((LoadInteger(ConstTable___ht, (((136))), (((GetHandleId(((LoadRectHandle(UserDefinedRects__hashTable, (GetHandleId((GetTriggerUnit()))), (0)))))))))))), (( ((0.)*1.0))*1.0)) // INLINED!!
        endif
        call DisplayTextToPlayer(GetOwningPlayer(GetTriggerUnit()), 0, 0, ("Fog " + ("|c000000ffBlue|r" ) + " set to: " + I2S(R2I((( (LoadReal(ConstTable___ht, (((((134))))), (((LoadInteger(ConstTable___ht, (((136))), (((GetHandleId(((LoadRectHandle(UserDefinedRects__hashTable, (GetHandleId((GetTriggerUnit()))), (0)))))))))))))))*1.0) * 100. + .5)) + "%")) // INLINED!!
    
    elseif abilityId == ('UDRF') then
        if (LoadReal(ConstTable___ht, (((((134))))), (((LoadInteger(ConstTable___ht, (((136))), (((GetHandleId(((LoadRectHandle(UserDefinedRects__hashTable, (GetHandleId((GetTriggerUnit()))), (0)))))))))))))) >= 0.01 then // INLINED!!
            call SaveReal(ConstTable___ht, (((((134))))), (((LoadInteger(ConstTable___ht, (((136))), (((GetHandleId(((LoadRectHandle(UserDefinedRects__hashTable, (GetHandleId((GetTriggerUnit()))), (0)))))))))))), (( (((LoadReal(ConstTable___ht, (((((134))))), (((LoadInteger(ConstTable___ht, (((136))), (((GetHandleId(((LoadRectHandle(UserDefinedRects__hashTable, (GetHandleId((GetTriggerUnit()))), (0)))))))))))))) - .05)*1.0))*1.0)) // INLINED!!
        else
            call SaveReal(ConstTable___ht, (((((134))))), (((LoadInteger(ConstTable___ht, (((136))), (((GetHandleId(((LoadRectHandle(UserDefinedRects__hashTable, (GetHandleId((GetTriggerUnit()))), (0)))))))))))), (( ((1.)*1.0))*1.0)) // INLINED!!
        endif
        call DisplayTextToPlayer(GetOwningPlayer(GetTriggerUnit()), 0, 0, ("Fog " + ("|c000000ffBlue|r" ) + " set to: " + I2S(R2I((( (LoadReal(ConstTable___ht, (((((134))))), (((LoadInteger(ConstTable___ht, (((136))), (((GetHandleId(((LoadRectHandle(UserDefinedRects__hashTable, (GetHandleId((GetTriggerUnit()))), (0)))))))))))))))*1.0) * 100. + .5)) + "%")) // INLINED!!
    
    elseif abilityId == ('UDRG') then
        if (LoadReal(ConstTable___ht, (((((132))))), (((LoadInteger(ConstTable___ht, (((136))), (((GetHandleId(((LoadRectHandle(UserDefinedRects__hashTable, (GetHandleId((GetTriggerUnit()))), (0)))))))))))))) <= .96 then // INLINED!!
            call SaveReal(ConstTable___ht, (((((132))))), (((LoadInteger(ConstTable___ht, (((136))), (((GetHandleId(((LoadRectHandle(UserDefinedRects__hashTable, (GetHandleId((GetTriggerUnit()))), (0)))))))))))), (( (((LoadReal(ConstTable___ht, (((((132))))), (((LoadInteger(ConstTable___ht, (((136))), (((GetHandleId(((LoadRectHandle(UserDefinedRects__hashTable, (GetHandleId((GetTriggerUnit()))), (0)))))))))))))) + .05)*1.0))*1.0)) // INLINED!!
        else
            call SaveReal(ConstTable___ht, (((((132))))), (((LoadInteger(ConstTable___ht, (((136))), (((GetHandleId(((LoadRectHandle(UserDefinedRects__hashTable, (GetHandleId((GetTriggerUnit()))), (0)))))))))))), (( ((0.)*1.0))*1.0)) // INLINED!!
        endif
        call DisplayTextToPlayer(GetOwningPlayer(GetTriggerUnit()), 0, 0, ("Fog " + ("|c0000ff00Green|r" ) + " set to: " + I2S(R2I((( (LoadReal(ConstTable___ht, (((((132))))), (((LoadInteger(ConstTable___ht, (((136))), (((GetHandleId(((LoadRectHandle(UserDefinedRects__hashTable, (GetHandleId((GetTriggerUnit()))), (0)))))))))))))))*1.0) * 100. + .5)) + "%")) // INLINED!!
    
    elseif abilityId == ('UDRH') then
        if (LoadReal(ConstTable___ht, (((((132))))), (((LoadInteger(ConstTable___ht, (((136))), (((GetHandleId(((LoadRectHandle(UserDefinedRects__hashTable, (GetHandleId((GetTriggerUnit()))), (0)))))))))))))) >= 0.01 then // INLINED!!
            call SaveReal(ConstTable___ht, (((((132))))), (((LoadInteger(ConstTable___ht, (((136))), (((GetHandleId(((LoadRectHandle(UserDefinedRects__hashTable, (GetHandleId((GetTriggerUnit()))), (0)))))))))))), (( (((LoadReal(ConstTable___ht, (((((132))))), (((LoadInteger(ConstTable___ht, (((136))), (((GetHandleId(((LoadRectHandle(UserDefinedRects__hashTable, (GetHandleId((GetTriggerUnit()))), (0)))))))))))))) - .05)*1.0))*1.0)) // INLINED!!
        else
            call SaveReal(ConstTable___ht, (((((132))))), (((LoadInteger(ConstTable___ht, (((136))), (((GetHandleId(((LoadRectHandle(UserDefinedRects__hashTable, (GetHandleId((GetTriggerUnit()))), (0)))))))))))), (( ((1.)*1.0))*1.0)) // INLINED!!
        endif
        call DisplayTextToPlayer(GetOwningPlayer(GetTriggerUnit()), 0, 0, ("Fog " + ("|c0000ff00Green|r" ) + " set to: " + I2S(R2I((( (LoadReal(ConstTable___ht, (((((132))))), (((LoadInteger(ConstTable___ht, (((136))), (((GetHandleId(((LoadRectHandle(UserDefinedRects__hashTable, (GetHandleId((GetTriggerUnit()))), (0)))))))))))))))*1.0) * 100. + .5)) + "%")) // INLINED!!
    ...
    elseif abilityId == ('UDRO') then
        ...
        call DisplayTextToPlayer(GetOwningPlayer(GetTriggerUnit()), 0, 0, "Fog Density set to: " + R2S((LoadReal(ConstTable___ht, (((((128))))), (((LoadInteger(ConstTable___ht, (((136))), (((GetHandleId(((LoadRectHandle(UserDefinedRects__hashTable, (GetHandleId((GetTriggerUnit()))), (0)))))))))))))) * 100) + "%") // INLINED!!
    
    elseif abilityId == ('UDRP') then
        if (LoadReal(ConstTable___ht, (((((128))))), (((LoadInteger(ConstTable___ht, (((136))), (((GetHandleId(((LoadRectHandle(UserDefinedRects__hashTable, (GetHandleId((GetTriggerUnit()))), (0)))))))))))))) >= 0.00006 then // INLINED!!
            call SaveReal(ConstTable___ht, (((((128))))), (((LoadInteger(ConstTable___ht, (((136))), (((GetHandleId(((LoadRectHandle(UserDefinedRects__hashTable, (GetHandleId((GetTriggerUnit()))), (0)))))))))))), (( (((LoadReal(ConstTable___ht, (((((128))))), (((LoadInteger(ConstTable___ht, (((136))), (((GetHandleId(((LoadRectHandle(UserDefinedRects__hashTable, (GetHandleId((GetTriggerUnit()))), (0)))))))))))))) - .00005)*1.0))*1.0)) // INLINED!!
        else
            call SaveReal(ConstTable___ht, (((((128))))), (((LoadInteger(ConstTable___ht, (((136))), (((GetHandleId(((LoadRectHandle(UserDefinedRects__hashTable, (GetHandleId((GetTriggerUnit()))), (0)))))))))))), (( ((0.)*1.0))*1.0)) // INLINED!!
        endif
        call DisplayTextToPlayer(GetOwningPlayer(GetTriggerUnit()), 0, 0, "Fog Density set to: " + R2S((LoadReal(ConstTable___ht, (((((128))))), (((LoadInteger(ConstTable___ht, (((136))), (((GetHandleId(((LoadRectHandle(UserDefinedRects__hashTable, (GetHandleId((GetTriggerUnit()))), (0)))))))))))))) * 100) + "%") // INLINED!!
    ...
    elseif abilityId == ('UDRK') then
        ...
        call DisplayTextToPlayer(GetOwningPlayer(GetTriggerUnit()), 0, 0, ( "Fog zStart set to: " + R2S((LoadReal(ConstTable___ht, (((((124))))), (((LoadInteger(ConstTable___ht, (((136))), (((GetHandleId(((LoadRectHandle(UserDefinedRects__hashTable, (GetHandleId((GetTriggerUnit()))), (0))))))))))))))) )) // INLINED!!
    
    elseif abilityId == ('UDRL') then
        if (LoadReal(ConstTable___ht, (((((124))))), (((LoadInteger(ConstTable___ht, (((136))), (((GetHandleId(((LoadRectHandle(UserDefinedRects__hashTable, (GetHandleId((GetTriggerUnit()))), (0)))))))))))))) >= 1200. then // INLINED!!
            call SaveReal(ConstTable___ht, (((((124))))), (((LoadInteger(ConstTable___ht, (((136))), (((GetHandleId(((LoadRectHandle(UserDefinedRects__hashTable, (GetHandleId((GetTriggerUnit()))), (0)))))))))))), (( (((LoadReal(ConstTable___ht, (((((124))))), (((LoadInteger(ConstTable___ht, (((136))), (((GetHandleId(((LoadRectHandle(UserDefinedRects__hashTable, (GetHandleId((GetTriggerUnit()))), (0)))))))))))))) - 1000.)*1.0))*1.0)) // INLINED!!
        else
            call SaveReal(ConstTable___ht, (((((124))))), (((LoadInteger(ConstTable___ht, (((136))), (((GetHandleId(((LoadRectHandle(UserDefinedRects__hashTable, (GetHandleId((GetTriggerUnit()))), (0)))))))))))), (( ((0.)*1.0))*1.0)) // INLINED!!
        endif
        call DisplayTextToPlayer(GetOwningPlayer(GetTriggerUnit()), 0, 0, ( "Fog zStart set to: " + R2S((LoadReal(ConstTable___ht, (((((124))))), (((LoadInteger(ConstTable___ht, (((136))), (((GetHandleId(((LoadRectHandle(UserDefinedRects__hashTable, (GetHandleId((GetTriggerUnit()))), (0))))))))))))))) )) // INLINED!!
    ...
    elseif abilityId == ('UDRM') then
        ...
        call DisplayTextToPlayer(GetOwningPlayer(GetTriggerUnit()), 0, 0, ( "Fog zEnd set to: " + R2S((LoadReal(ConstTable___ht, (((((126))))), (((LoadInteger(ConstTable___ht, (((136))), (((GetHandleId(((LoadRectHandle(UserDefinedRects__hashTable, (GetHandleId((GetTriggerUnit()))), (0))))))))))))))) )) // INLINED!!
    
    elseif abilityId == ('UDRN') then
        if (LoadReal(ConstTable___ht, (((((126))))), (((LoadInteger(ConstTable___ht, (((136))), (((GetHandleId(((LoadRectHandle(UserDefinedRects__hashTable, (GetHandleId((GetTriggerUnit()))), (0)))))))))))))) >= 1200. then // INLINED!!
            call SaveReal(ConstTable___ht, (((((126))))), (((LoadInteger(ConstTable___ht, (((136))), (((GetHandleId(((LoadRectHandle(UserDefinedRects__hashTable, (GetHandleId((GetTriggerUnit()))), (0)))))))))))), (( (((LoadReal(ConstTable___ht, (((((126))))), (((LoadInteger(ConstTable___ht, (((136))), (((GetHandleId(((LoadRectHandle(UserDefinedRects__hashTable, (GetHandleId((GetTriggerUnit()))), (0)))))))))))))) - 500.)*1.0))*1.0)) // INLINED!!
        else
            call SaveReal(ConstTable___ht, (((((126))))), (((LoadInteger(ConstTable___ht, (((136))), (((GetHandleId(((LoadRectHandle(UserDefinedRects__hashTable, (GetHandleId((GetTriggerUnit()))), (0)))))))))))), (( ((0.)*1.0))*1.0)) // INLINED!!
        endif
        call DisplayTextToPlayer(GetOwningPlayer(GetTriggerUnit()), 0, 0, ( "Fog zEnd set to: " + R2S((LoadReal(ConstTable___ht, (((((126))))), (((LoadInteger(ConstTable___ht, (((136))), (((GetHandleId(((LoadRectHandle(UserDefinedRects__hashTable, (GetHandleId((GetTriggerUnit()))), (0))))))))))))))) )) // INLINED!!
    ...
    elseif abilityId == ('UDRI') then
        ...
        call DisplayTextToPlayer(GetOwningPlayer(GetTriggerUnit()), 0, 0, "Fog Style set to: " + (LoadStr(ConstTable___ht, (((((14))))), ((LoadInteger(ConstTable___ht, (((((122))))), (((LoadInteger(ConstTable___ht, (((136))), (((GetHandleId(((LoadRectHandle(UserDefinedRects__hashTable, (GetHandleId((GetTriggerUnit()))), (0)))))))))))))))))) // INLINED!!
    ...
    elseif abilityId == ('UDRT') then
        ...
        if CountUnitsInGroup((LoadGroupHandle(UserDefinedRects__hashTable, (GetHandleId((GetTriggerUnit()))), (6)))) <= (300) then // INLINED!!
...
function UserDefinedRectsGeneratorAddon__onSpawn takes nothing returns boolean
    if (GetUnitTypeId((GetTriggerUnit())) == ('udr0')) then // INLINED!!
...
function UserDefinedRectsGeneratorAddon__onInit takes nothing returns nothing
    ...
    call SaveStr(ConstTable___ht, (((((14))))), ((0)), ( "Linear")) // INLINED!!
    call SaveStr(ConstTable___ht, (((((14))))), ((1)), ( "Exponential 1")) // INLINED!!
    call SaveStr(ConstTable___ht, (((((14))))), ((2)), ( "Exponential 2")) // INLINED!!
    
//textmacro instance: udrAddon_LinkStyles("TerrainFog.LINEAR", "TerrainFog.EXPONENTIAL")
    call SaveInteger(ConstTable___ht, (((16))), (((0) )), ( ( (1)))) // INLINED!!
    call SaveInteger(ConstTable___ht, (((18))), (((1) )), ( ( (0)))) // INLINED!!
...
//textmacro instance: udrAddon_LinkStyles("TerrainFog.EXPONENTIAL", "TerrainFog.EXPONENTIAL2")
    call SaveInteger(ConstTable___ht, (((16))), (((1) )), ( ( (2)))) // INLINED!!
    call SaveInteger(ConstTable___ht, (((18))), (((2) )), ( ( (1)))) // INLINED!!
...
//textmacro instance: udrAddon_LinkStyles("TerrainFog.EXPONENTIAL2", "TerrainFog.LINEAR")
    call SaveInteger(ConstTable___ht, (((16))), (((2) )), ( ( (0)))) // INLINED!!
    call SaveInteger(ConstTable___ht, (((18))), (((0) )), ( ( (2)))) // INLINED!!
...
function Trig_Register_Test_Rects_Actions takes nothing returns nothing
    ...
    call SaveInteger(ConstTable___ht, (((136))), ((env)), ( ((GMUI_GetIndex(((0))))))) // INLINED!!
    call SaveReal(ConstTable___ht, (((((128))))), (((LoadInteger(ConstTable___ht, (((136))), ((env)))))), (( ((10.)*1.0))*1.0)) // INLINED!!
    call SaveReal(ConstTable___ht, (((((124))))), (((LoadInteger(ConstTable___ht, (((136))), ((env)))))), (( ((0.)*1.0))*1.0)) // INLINED!!
    call SaveReal(ConstTable___ht, (((((126))))), (((LoadInteger(ConstTable___ht, (((136))), ((env)))))), (( ((8000.)*1.0))*1.0)) // INLINED!!
    ...
    call SaveReal(ConstTable___ht, (((((124))))), (((LoadInteger(ConstTable___ht, (((136))), ((env)))))), (( ((0.)*1.0))*1.0)) // INLINED!!
    call SaveReal(ConstTable___ht, (((((126))))), (((LoadInteger(ConstTable___ht, (((136))), ((env)))))), (( ((8000.)*1.0))*1.0)) // INLINED!!
    call SaveReal(ConstTable___ht, (((((130))))), (((LoadInteger(ConstTable___ht, (((136))), ((env)))))), (( ((100.)*1.0))*1.0)) // INLINED!!
    call SaveReal(ConstTable___ht, (((((132))))), (((LoadInteger(ConstTable___ht, (((136))), ((env)))))), (( ((100.)*1.0))*1.0)) // INLINED!!
    call SaveReal(ConstTable___ht, (((((134))))), (((LoadInteger(ConstTable___ht, (((136))), ((env)))))), (( ((100.)*1.0))*1.0)) // INLINED!!
endfunction
...
function AAAA___SetEnumHero takes unit value returns nothing
    call s__Args_setAgent((36) , ((0 ) ) , ( ( value))) // INLINED!!
endfunction
...
function AAAA___FreeEnumHero takes nothing returns nothing
    call s__Args_freeHandle((36) , ((0))) // INLINED!!
endfunction
...
function Trig_Untitled_Trigger_007_Actions takes nothing returns nothing
    ...
    call s__Args_setAgent((36) , ((0 ) ) , ( ( (CreateUnit(Player(0), 'Hpal', 0, 0, 0))))) // INLINED!!
    call BJDebugMsg(GetHeroProperName((s__Args_getUnit((0))))) // INLINED!!
    
    call BJDebugMsg(I2S((s__Args_getInteger((0))))) // INLINED!!
    
    call s__Args_setAgent((36) , ((0 ) ) , ( ( (CreateUnit(Player(0), 'Hblm', 0, 0, 0))))) // INLINED!!
    call BJDebugMsg(GetHeroProperName((s__Args_getUnit((0))))) // INLINED!!
